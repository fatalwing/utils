...
import com.townmc.utils.jackson.databind.type.TypeBase;
import com.townmc.utils.jackson.databind.type.TypeBindings;
import com.townmc.utils.jackson.databind.type.TypeModifier;

/**
 * Specialized {@link com.townmc.utils.jackson.databind.type.SimpleType} for types that are referential types,
 ...
 * @since 2.6
 */
public class ReferenceType extends com.townmc.utils.jackson.databind.type.SimpleType
{
     ...
     * a {@link com.townmc.utils.jackson.databind.type.SimpleType} is upgraded into reference type, but NOT changed
    ...
    protected ReferenceType(Class<?> cls, com.townmc.utils.jackson.databind.type.TypeBindings bindings,
     ...
     * @since 2.7
     */
    protected ReferenceType(com.townmc.utils.jackson.databind.type.TypeBase base, JavaType refType)
    {
        super(base);
        _referencedType = refType;
    ...
    public static ReferenceType upgradeFrom(JavaType baseType, JavaType refdType) {
        ...
        if (baseType instanceof com.townmc.utils.jackson.databind.type.TypeBase) {
     ...
     * @since 2.7
     */
    public static ReferenceType construct(Class<?> cls, com.townmc.utils.jackson.databind.type.TypeBindings bindings,
            JavaType superClass, JavaType[] superInts, JavaType refType)
    {
    ...
    public static ReferenceType construct(Class<?> cls, JavaType refType) {
        return new ReferenceType(cls, com.townmc.utils.jackson.databind.type.TypeBindings.emptyBindings(),

...
public abstract class DatabindContext
{
    ...
    /**
     * Convenience method for constructing {@link com.townmc.utils.jackson.databind.JavaType} for given JDK
     * type (usually {@link Class})
     */
    public com.townmc.utils.jackson.databind.JavaType constructType(Type type) {
        if (type == null) {
            return null;
        }
     ...
     */
    public com.townmc.utils.jackson.databind.JavaType constructSpecializedType(com.townmc.utils.jackson.databind.JavaType baseType, Class<?> subclass) {
     ...
     * @since 2.9
     */
    public com.townmc.utils.jackson.databind.JavaType resolveSubType(com.townmc.utils.jackson.databind.JavaType baseType, String subClass)
     ...
     * @since 2.9
     */
    protected abstract JsonMappingException invalidTypeIdException(com.townmc.utils.jackson.databind.JavaType baseType, String typeId,
                                                                   String extraDesc);
     ...
     * means throwing a {@link com.townmc.utils.jackson.databind.exc.InvalidDefinitionException}.
     *
     * @since 2.9
     */

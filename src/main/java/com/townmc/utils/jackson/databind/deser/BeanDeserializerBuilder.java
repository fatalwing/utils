...
import com.townmc.utils.jackson.databind.deser.BeanDeserializer;
import com.townmc.utils.jackson.databind.deser.SettableAnyProperty;
...
import com.townmc.utils.jackson.databind.deser.impl.BeanPropertyMap;
import com.townmc.utils.jackson.databind.deser.impl.ObjectIdValueProperty;
import com.townmc.utils.jackson.databind.deser.impl.ObjectIdReader;
import com.townmc.utils.jackson.databind.deser.impl.ValueInjector;
import com.townmc.utils.jackson.databind.introspect.*;
import com.townmc.utils.jackson.databind.util.Annotations;
...
public class BeanDeserializerBuilder
{
     ...
     */
    final protected Map<String, com.townmc.utils.jackson.databind.deser.SettableBeanProperty> _properties
        = new LinkedHashMap<String, com.townmc.utils.jackson.databind.deser.SettableBeanProperty>();
     ...
     */
    protected HashMap<String, com.townmc.utils.jackson.databind.deser.SettableBeanProperty> _backRefProperties;
     ...
     */
    protected com.townmc.utils.jackson.databind.deser.ValueInstantiator _valueInstantiator;
     ...
     */
    protected com.townmc.utils.jackson.databind.deser.SettableAnyProperty _anySetter;
    ...
    private static HashMap<String, com.townmc.utils.jackson.databind.deser.SettableBeanProperty> _copy(HashMap<String, com.townmc.utils.jackson.databind.deser.SettableBeanProperty> src) {
        return (src == null) ? null
                : new HashMap<String, com.townmc.utils.jackson.databind.deser.SettableBeanProperty>(src);
    }
     ...
     */
    public void addOrReplaceProperty(com.townmc.utils.jackson.databind.deser.SettableBeanProperty prop, boolean allowOverride) {
     ...
     */
    public void addProperty(com.townmc.utils.jackson.databind.deser.SettableBeanProperty prop)
    {
        com.townmc.utils.jackson.databind.deser.SettableBeanProperty old =  _properties.put(prop.getName(), prop);
     ...
     */
    public void  addBackReferenceProperty(String referenceName, com.townmc.utils.jackson.databind.deser.SettableBeanProperty prop)
    {
        if (_backRefProperties == null) {
            _backRefProperties = new HashMap<String, com.townmc.utils.jackson.databind.deser.SettableBeanProperty>(4);
        }
     ...
     */
    public void addCreatorProperty(com.townmc.utils.jackson.databind.deser.SettableBeanProperty prop)
    {
        addProperty(prop);
    }

    public void setAnySetter(com.townmc.utils.jackson.databind.deser.SettableAnyProperty s)
    {
    ...
    public void setValueInstantiator(com.townmc.utils.jackson.databind.deser.ValueInstantiator inst) {
     ...
     * order.
     */
    public Iterator<com.townmc.utils.jackson.databind.deser.SettableBeanProperty> getProperties() {
        return _properties.values().iterator();
    }

    public com.townmc.utils.jackson.databind.deser.SettableBeanProperty findProperty(PropertyName propertyName) {
    ...
    public com.townmc.utils.jackson.databind.deser.SettableBeanProperty removeProperty(PropertyName name) {
    ...
    /**
     * Method for constructing a {@link com.townmc.utils.jackson.databind.deser.BeanDeserializer}, given all
     * information collected.
     */
    public JsonDeserializer<?> build()
    {
        Collection<com.townmc.utils.jackson.databind.deser.SettableBeanProperty> props = _properties.values();
        _fixAccess(props);
        ...
        if (!anyViews) {
            for (com.townmc.utils.jackson.databind.deser.SettableBeanProperty prop : props) {
                if (prop.hasViews()) {
                    anyViews = true;
                    break;
                }
     ...
     * @since 2.0
     */
    public com.townmc.utils.jackson.databind.deser.AbstractDeserializer buildAbstract() {
    ...
    protected void _fixAccess(Collection<com.townmc.utils.jackson.databind.deser.SettableBeanProperty> mainProps)
    {
        ...
        */
        for (com.townmc.utils.jackson.databind.deser.SettableBeanProperty prop : mainProps) {
            /*
...
/*        
    ...
    protected Map<String,List<PropertyName>> _collectAliases(Collection<com.townmc.utils.jackson.databind.deser.SettableBeanProperty> props)
    {

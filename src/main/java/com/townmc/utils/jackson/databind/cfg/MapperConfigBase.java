...
import com.townmc.utils.jackson.annotation.JsonAutoDetect.Visibility;
...
import com.townmc.utils.jackson.databind.cfg.BaseSettings;
import com.townmc.utils.jackson.databind.cfg.ConfigFeature;
import com.townmc.utils.jackson.databind.cfg.ConfigOverride;
import com.townmc.utils.jackson.databind.cfg.ConfigOverrides;
...
import com.townmc.utils.jackson.databind.introspect.SimpleMixInResolver;
import com.townmc.utils.jackson.databind.introspect.VisibilityChecker;
import com.townmc.utils.jackson.databind.jsontype.SubtypeResolver;
    ...
    implements java.io.Serializable
{
     ...
     * @since 2.9
     */
    protected final static com.townmc.utils.jackson.databind.cfg.ConfigOverride EMPTY_OVERRIDE = com.townmc.utils.jackson.databind.cfg.ConfigOverride.empty();
     ...
     * and may NOT be demoted down to {@link com.townmc.utils.jackson.databind.cfg.BaseSettings}.
     */
     ...
     * @since 2.8
     */
    protected final com.townmc.utils.jackson.databind.cfg.ConfigOverrides _configOverrides;
     ...
     * @since 2.8
     */
    protected MapperConfigBase(com.townmc.utils.jackson.databind.cfg.BaseSettings base,
                               SubtypeResolver str, SimpleMixInResolver mixins, RootNameLookup rootNames,
                               com.townmc.utils.jackson.databind.cfg.ConfigOverrides configOverrides)
    {
    ...
    protected MapperConfigBase(MapperConfigBase<CFG,T> src, com.townmc.utils.jackson.databind.cfg.BaseSettings base)
    {
        super(src, base);
        _mixIns = src._mixIns;
        _subtypeResolver = src._subtypeResolver;
    ...
    @Override
    public final com.townmc.utils.jackson.databind.cfg.ConfigOverride getConfigOverride(Class<?> type) {
        com.townmc.utils.jackson.databind.cfg.ConfigOverride override = _configOverrides.findOverride(type);
        return (override == null) ? EMPTY_OVERRIDE : override;
    }

    @Override
    public final com.townmc.utils.jackson.databind.cfg.ConfigOverride findConfigOverride(Class<?> type) {
    ...
    public final JsonFormat.Value getDefaultPropertyFormat(Class<?> type) {
        com.townmc.utils.jackson.databind.cfg.ConfigOverride overrides = _configOverrides.findOverride(type);
        if (overrides != null) {
    ...
    public final VisibilityChecker<?> getDefaultVisibilityChecker(Class<?> baseType,
        ...
        com.townmc.utils.jackson.databind.cfg.ConfigOverride overrides = _configOverrides.findOverride(baseType);
        if (overrides != null) {

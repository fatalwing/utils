...
public interface TypeResolverBuilder<T extends TypeResolverBuilder<T>>
{
    ...
    public TypeSerializer buildTypeSerializer(SerializationConfig config,
                                              JavaType baseType, Collection<com.townmc.utils.jackson.databind.jsontype.NamedType> subtypes);
     ...
     * {@link com.townmc.utils.jackson.databind.JsonDeserializer}s or not.
     * 
     * @return Resulting builder instance (usually this builder,
     *   but may be a newly constructed instance for immutable builders}
     * 

...
import com.townmc.utils.jackson.databind.ser.ContainerSerializer;
import com.townmc.utils.jackson.databind.ser.SerializerFactory;
import com.townmc.utils.jackson.databind.ser.Serializers;
import com.townmc.utils.jackson.databind.ser.impl.*;
import com.townmc.utils.jackson.databind.ser.std.*;
...
public abstract class BasicSerializerFactory
    extends com.townmc.utils.jackson.databind.ser.SerializerFactory
    implements java.io.Serializable
{
     ...
     * {@link com.townmc.utils.jackson.databind.ser.BeanSerializerFactory} for more details.
     */
    public abstract com.townmc.utils.jackson.databind.ser.SerializerFactory withConfig(SerializerFactoryConfig config);
     ...
     */
    @Override
    public final com.townmc.utils.jackson.databind.ser.SerializerFactory withAdditionalSerializers(com.townmc.utils.jackson.databind.ser.Serializers additional) {
     ...
     */
    @Override
    public final com.townmc.utils.jackson.databind.ser.SerializerFactory withAdditionalKeySerializers(com.townmc.utils.jackson.databind.ser.Serializers additional) {
            ...
            JavaType keyType, JsonSerializer<Object> defaultImpl)
    {
        ...
        if (_factoryConfig.hasKeySerializers()) {
            ...
            for (com.townmc.utils.jackson.databind.ser.Serializers serializers : _factoryConfig.keySerializers()) {
    ...
    protected abstract Iterable<com.townmc.utils.jackson.databind.ser.Serializers> customSerializers();
     ...
     *  </li>
     * <li>If type has {@link com.townmc.utils.jackson.annotation.JsonValue} annotation (or equivalent), build serializer
     ...
     * has an annotation
     * (@link com.townmc.utils.jackson.databind.annotation.JsonSerialize#using)
        ...
        throws JsonMappingException
    {
        ...
        if (type.isMapLikeType()) { // implements java.util.Map
            ...
            for (com.townmc.utils.jackson.databind.ser.Serializers serializers : customSerializers()) { // (1) Custom
    ...
    public com.townmc.utils.jackson.databind.ser.ContainerSerializer<?> buildIndexedListSerializer(JavaType elemType,

...
import com.townmc.utils.jackson.databind.util.LinkedNode;
import com.townmc.utils.jackson.databind.util.RootNameLookup;

/**
 * Object that contains baseline configuration for deserialization
 * process. An instance is owned by {@link com.townmc.utils.jackson.databind.ObjectMapper}, which
    ...
    implements java.io.Serializable // since 2.1
{
    ...
    /**
     * Factory used for constructing {@link com.townmc.utils.jackson.databind.JsonNode} instances.
     */
    ...
    /**
     * Copy-constructor used for making a copy used by new {@link com.townmc.utils.jackson.databind.ObjectMapper}.
     *
     * @since 2.9
     */
    ...
    private DeserializationConfig(DeserializationConfig src, com.townmc.utils.jackson.databind.PropertyName rootName)
    {
        super(src, rootName);
        _deserFeatures = src._deserFeatures;
        _problemHandlers = src._problemHandlers;
    ...
    public <T extends com.townmc.utils.jackson.databind.BeanDescription> T introspect(com.townmc.utils.jackson.databind.JavaType type) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends com.townmc.utils.jackson.databind.BeanDescription> T introspectForCreation(com.townmc.utils.jackson.databind.JavaType type) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends com.townmc.utils.jackson.databind.BeanDescription> T introspectForBuilder(com.townmc.utils.jackson.databind.JavaType type) {

...
import com.townmc.utils.jackson.databind.ser.impl.UnwrappingBeanSerializer;
    ...
    implements java.io.Serializable
{
            ...
            throws Exception
    {
        ...
        if (ser == null) {
            ...
            com.townmc.utils.jackson.databind.ser.impl.PropertySerializerMap map = _dynamicSerializers;
    ...
    public void assignSerializer(JsonSerializer<Object> ser)
    {
        if (ser != null) {
            ...
            if (ser.isUnwrappingSerializer()) {
                t = NameTransformer.chainedTransformer(t, ((com.townmc.utils.jackson.databind.ser.impl.UnwrappingBeanSerializer) ser)._nameTransformer);
            }

...
import com.townmc.utils.jackson.databind.ser.ContextualSerializer;
import com.townmc.utils.jackson.databind.ser.PropertyFilter;
import com.townmc.utils.jackson.databind.ser.impl.PropertySerializerMap;
import com.townmc.utils.jackson.databind.ser.std.MapProperty;
    ...
    implements ContextualSerializer
{
    ...
    {
        final Set<String> ignored = _ignoredEntries;
        final com.townmc.utils.jackson.databind.ser.std.MapProperty prop = new com.townmc.utils.jackson.databind.ser.std.MapProperty(_valueTypeSerializer, _property);
        final boolean checkEmpty = (MARKER_FOR_EMPTY == suppressableValue);
    ...
    {
        final Set<String> ignored = _ignoredEntries;
        final com.townmc.utils.jackson.databind.ser.std.MapProperty prop = new MapProperty(_valueTypeSerializer, _property);
        final boolean checkEmpty = (MARKER_FOR_EMPTY == suppressableValue);

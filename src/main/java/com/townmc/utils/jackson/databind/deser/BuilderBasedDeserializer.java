...
import com.townmc.utils.jackson.databind.deser.BeanDeserializerBase;
...
public class BuilderBasedDeserializer
    extends com.townmc.utils.jackson.databind.deser.BeanDeserializerBase
{
    ...
    /**
     * Constructor used by {@link com.townmc.utils.jackson.databind.deser.BeanDeserializerBuilder}.
     */
    public BuilderBasedDeserializer(com.townmc.utils.jackson.databind.deser.BeanDeserializerBuilder builder,
                                    BeanDescription beanDesc, JavaType targetType,
                                    BeanPropertyMap properties, Map<String, com.townmc.utils.jackson.databind.deser.SettableBeanProperty> backRefs,
    ...
    @Override
    public com.townmc.utils.jackson.databind.deser.BeanDeserializerBase withObjectIdReader(ObjectIdReader oir) {
        return new BuilderBasedDeserializer(this, oir);
    }

    @Override
    public com.townmc.utils.jackson.databind.deser.BeanDeserializerBase withIgnorableProperties(Set<String> ignorableProps) {
        return new BuilderBasedDeserializer(this, ignorableProps);
    }

    @Override
    public com.townmc.utils.jackson.databind.deser.BeanDeserializerBase withBeanProperties(BeanPropertyMap props) {
        return new BuilderBasedDeserializer(this, props);
    }

    @Override
    protected BeanDeserializerBase asArrayDeserializer() {
        com.townmc.utils.jackson.databind.deser.SettableBeanProperty[] props = _beanProperties.getPropertiesInInsertionOrder();
        ...
        throws IOException
    {
        ...
        for (; p.getCurrentToken() != JsonToken.END_OBJECT; p.nextToken()) {
            ...
            // Skip field name:
            p.nextToken();
            com.townmc.utils.jackson.databind.deser.SettableBeanProperty prop = _beanProperties.find(propName);
    ...
    { 
        ...
        for (; t == JsonToken.FIELD_NAME; t = p.nextToken()) {
            ...
            // creator property?
            com.townmc.utils.jackson.databind.deser.SettableBeanProperty creatorProp = creator.findCreatorProperty(propName);
            if (creatorProp != null) {

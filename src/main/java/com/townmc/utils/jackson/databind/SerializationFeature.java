 ...
 * {@link com.townmc.utils.jackson.databind.ObjectMapper} (as sort of defaults) and through
 ...
 * changes must be done using {@link com.townmc.utils.jackson.databind.ObjectWriter}.
 */
public enum SerializationFeature implements ConfigFeature
{
     ...
     * printer configured for {@link com.townmc.utils.jackson.databind.ObjectMapper} (and
     * {@link com.townmc.utils.jackson.databind.ObjectWriter}s created from mapper).
     *<p>
     * Note that the default pretty printer is only used if
     * no explicit {@link com.townmc.utils.jackson.core.PrettyPrinter} has been configured
     * for the generator or {@link com.townmc.utils.jackson.databind.ObjectWriter}.
     *<p>
     * Feature is disabled by default.
     */
    INDENT_OUTPUT(false),
     ...
     * in conjunction with {@link com.townmc.utils.jackson.annotation.JsonUnwrapped}.
     ...
     * that use other destinations); same for methods in {@link com.townmc.utils.jackson.databind.ObjectWriter}.
     ...
     * {@link com.townmc.utils.jackson.databind.SerializationConfig#getDateFormat}:
     * the default setting being {@link com.townmc.utils.jackson.databind.util.StdDateFormat},
     ...
     *   using {@link com.townmc.utils.jackson.annotation.JsonInclude} or configuration overrides
     ...
     * {@link com.townmc.utils.jackson.core.JsonGenerator#writeNumber(String)}
     * it may cause compatibility problems since not all {@link com.townmc.utils.jackson.core.JsonGenerator}
     * implementations support such mode of output: usually only text-based formats
     * support it.
     *<p>
     * Feature is disabled by default.
     * 
     * @deprecated Since 2.5: use {@link com.townmc.utils.jackson.core.JsonGenerator.Feature#WRITE_BIGDECIMAL_AS_PLAIN} instead
     *    (using {@link com.townmc.utils.jackson.databind.ObjectWriter#with(com.townmc.utils.jackson.core.JsonGenerator.Feature)}).
     */
    ...
    /**
     * Feature that determines whether {@link com.townmc.utils.jackson.databind.ObjectWriter} should

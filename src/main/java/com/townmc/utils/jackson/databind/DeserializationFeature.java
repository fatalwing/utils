...
import com.townmc.utils.jackson.databind.cfg.ConfigFeature;
 ...
 * {@link com.townmc.utils.jackson.databind.ObjectReader}.
 * In first case these defaults must follow "config-then-use" patterns
 * (i.e. defined once, not changed afterwards); all per-call
 * changes must be done using {@link com.townmc.utils.jackson.databind.ObjectReader}.
 *<p>
...
public enum DeserializationFeature implements ConfigFeature
{
     ...
     * will throw a {@link com.townmc.utils.jackson.core.JsonProcessingException}.
     *<p>
     ...
     * {@link com.townmc.utils.jackson.databind.JsonMappingException}) or not.
     * This setting only takes effect after all other handling
     * methods for unknown properties have been tried, and
     * property remains unhandled.
     *<p>
     * Feature is enabled by default (meaning that a
     * {@link com.townmc.utils.jackson.databind.JsonMappingException} will be thrown if an unknown property
     * is encountered).
     */
     ...
     * not allowed and a {@link com.townmc.utils.jackson.databind.JsonMappingException} will be thrown.
     ...
     * value (indicated for example by {@link com.townmc.utils.jackson.annotation.JsonTypeInfo})
     ...
     * ({@link com.townmc.utils.jackson.core.TreeNode}) and a duplicate key
     * is encountered (property name that was already seen for the JSON Object).
     * If enabled, {@link com.townmc.utils.jackson.databind.JsonMappingException} will be thrown; if disabled, no exception
     ...
     * {@link com.townmc.utils.jackson.databind.JsonMappingException} is thrown; if false, property is quietly skipped.
     *<p>
     * Feature is disabled by default so that no exception is thrown.
     *
     * @since 2.3
     ...
     * If enabled, such missing values result in a {@link com.townmc.utils.jackson.databind.JsonMappingException} being
     ...
     * {@link com.townmc.utils.jackson.annotation.JsonTypeInfo.As#EXTERNAL_PROPERTY} is missing,
     * but associated type id is available. If enabled, {@link com.townmc.utils.jackson.databind.JsonMappingException} is always
     ...
     * {@link com.townmc.utils.jackson.core.JsonParser#nextToken} is made to ensure that
     * no more tokens are found (and if any is found,
     * {@link com.townmc.utils.jackson.databind.exc.MismatchedInputException} is thrown); if
     ...
     * {@link com.townmc.utils.jackson.databind.SerializationFeature#WRAP_ROOT_VALUE} used for serialization.
     * Will verify that the root JSON value is a JSON Object, and that it has
     * a single property with expected root name. If not, a
     * {@link com.townmc.utils.jackson.databind.JsonMappingException} is thrown; otherwise value of the wrapped property
     ...
     * as {@link com.townmc.utils.jackson.databind.SerializationFeature#WRITE_ENUMS_USING_TO_STRING}.
     *<p>
     * Feature is disabled by default.
     */
     ...
     * {@link com.townmc.utils.jackson.annotation.JsonEnumDefaultValue @JsonEnumDefaultValue} annotation.
     * If disabled, unknown Enum values will throw exceptions.
    ...
    /**
     * Feature that determines whether {@link com.townmc.utils.jackson.databind.ObjectReader} should

...
import com.townmc.utils.jackson.databind.ser.std.ArraySerializerBase;
import com.townmc.utils.jackson.databind.ser.std.ByteArraySerializer;
...
public class StdArraySerializers
{
    ...
    protected abstract static class TypedPrimitiveArraySerializer<T>
        extends com.townmc.utils.jackson.databind.ser.std.ArraySerializerBase<T>
    {
    ...
    public static class BooleanArraySerializer
        extends com.townmc.utils.jackson.databind.ser.std.ArraySerializerBase<boolean[]>
    {
    ...
    @JacksonStdImpl
    public static class IntArraySerializer extends com.townmc.utils.jackson.databind.ser.std.ArraySerializerBase<int[]>
    {
        // as above, assuming no one re-defines primitive/wrapper types
        @SuppressWarnings("deprecation")

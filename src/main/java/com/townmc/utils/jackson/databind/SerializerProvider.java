...
import com.townmc.utils.jackson.databind.deser.ContextualDeserializer;
...
import com.townmc.utils.jackson.databind.ser.impl.FailingSerializer;
import com.townmc.utils.jackson.databind.ser.impl.ReadOnlyClassToSerializerMap;
import com.townmc.utils.jackson.databind.ser.impl.TypeWrappedSerializer;
import com.townmc.utils.jackson.databind.ser.impl.UnknownSerializer;
import com.townmc.utils.jackson.databind.ser.impl.WritableObjectId;
import com.townmc.utils.jackson.databind.ser.std.NullSerializer;
import com.townmc.utils.jackson.databind.type.TypeFactory;
import com.townmc.utils.jackson.databind.util.ClassUtil;

/**
 * Class that defines API used by {@link com.townmc.utils.jackson.databind.ObjectMapper} and
 * {@link com.townmc.utils.jackson.databind.JsonSerializer}s to obtain serializers capable of serializing
    ...
    extends DatabindContext
{
    ...
    public final static com.townmc.utils.jackson.databind.JsonSerializer<Object> DEFAULT_NULL_KEY_SERIALIZER =
     ...
     */
    protected final static com.townmc.utils.jackson.databind.JsonSerializer<Object> DEFAULT_UNKNOWN_SERIALIZER = new UnknownSerializer();
     ...
     */
    protected com.townmc.utils.jackson.databind.JsonSerializer<Object> _unknownTypeSerializer = DEFAULT_UNKNOWN_SERIALIZER;
     ...
     */
    protected com.townmc.utils.jackson.databind.JsonSerializer<Object> _keySerializer;

    /**
     * Serializer used to output a null value. Default implementation
     * writes nulls using {@link JsonGenerator#writeNull}.
     */
    protected com.townmc.utils.jackson.databind.JsonSerializer<Object> _nullValueSerializer = NullSerializer.instance;
     ...
     * can be defined.
     */
    protected com.townmc.utils.jackson.databind.JsonSerializer<Object> _nullKeySerializer = DEFAULT_NULL_KEY_SERIALIZER;
     ...
     * name)
     */
    public void setDefaultKeySerializer(com.townmc.utils.jackson.databind.JsonSerializer<Object> ks)
    {
        if (ks == null) {
     ...
     * property.
     */
    public void setNullValueSerializer(com.townmc.utils.jackson.databind.JsonSerializer<Object> nvs)
    {
        if (nvs == null) {
            throw new IllegalArgumentException("Cannot pass null JsonSerializer");
        }
     ...
     * registrations.
     */
    public void setNullKeySerializer(com.townmc.utils.jackson.databind.JsonSerializer<Object> nks)
    {
        if (nks == null) {
            throw new IllegalArgumentException("Cannot pass null JsonSerializer");
        }
    ...
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> findValueSerializer(Class<?> valueType, com.townmc.utils.jackson.databind.BeanProperty property)
        throws JsonMappingException
    {
        // Fast lookup from local lookup thingy works?
        com.townmc.utils.jackson.databind.JsonSerializer<Object> ser = _knownSerializers.untypedValueSerializer(valueType);
        if (ser == null) {
        ...
        return (com.townmc.utils.jackson.databind.JsonSerializer<Object>) handleSecondaryContextualization(ser, property);
    }

    /**
     * Similar to {@link #findValueSerializer(Class, com.townmc.utils.jackson.databind.BeanProperty)}, but takes
     ...
     */
    @SuppressWarnings("unchecked")
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> findValueSerializer(com.townmc.utils.jackson.databind.JavaType valueType, com.townmc.utils.jackson.databind.BeanProperty property)
        throws JsonMappingException
    {
        if (valueType == null) {
     ...
     * @since 2.5
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> findValueSerializer(Class<?> valueType) throws JsonMappingException
    {
        // (see comments from above method)
        com.townmc.utils.jackson.databind.JsonSerializer<Object> ser = _knownSerializers.untypedValueSerializer(valueType);
        if (ser == null) {
     ...
     * @since 2.5
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> findValueSerializer(com.townmc.utils.jackson.databind.JavaType valueType)
        throws JsonMappingException
    {
        // (see comments from above method)
        com.townmc.utils.jackson.databind.JsonSerializer<Object> ser = _knownSerializers.untypedValueSerializer(valueType);
    ...
    /**
     * Similar to {@link #findValueSerializer(com.townmc.utils.jackson.databind.JavaType, com.townmc.utils.jackson.databind.BeanProperty)}, but used
     ...
     */
    @SuppressWarnings("unchecked")
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> findPrimaryPropertySerializer(com.townmc.utils.jackson.databind.JavaType valueType, com.townmc.utils.jackson.databind.BeanProperty property)
        throws JsonMappingException
    {
        com.townmc.utils.jackson.databind.JsonSerializer<Object> ser = _knownSerializers.untypedValueSerializer(valueType);
        if (ser == null) {
        ...
        return (com.townmc.utils.jackson.databind.JsonSerializer<Object>) handlePrimaryContextualization(ser, property);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> findPrimaryPropertySerializer(Class<?> valueType,
                                                                                               com.townmc.utils.jackson.databind.BeanProperty property)
        throws JsonMappingException
    {
        com.townmc.utils.jackson.databind.JsonSerializer<Object> ser = _knownSerializers.untypedValueSerializer(valueType);
        if (ser == null) {
     ...
     *   may be checked to create contextual serializers.
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> findTypedValueSerializer(Class<?> valueType,
                                                                                          boolean cache, com.townmc.utils.jackson.databind.BeanProperty property)
        throws JsonMappingException
    {
        // Two-phase lookups; local non-shared cache, then shared:
        com.townmc.utils.jackson.databind.JsonSerializer<Object> ser = _knownSerializers.typedValueSerializer(valueType);
        if (ser != null) {
            return ser;
        }
        // If not, maybe shared map already has it?
     ...
     *   may be checked to create contextual serializers.
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> findTypedValueSerializer(com.townmc.utils.jackson.databind.JavaType valueType, boolean cache,
                                                                                          com.townmc.utils.jackson.databind.BeanProperty property)
        throws JsonMappingException
    {
        // Two-phase lookups; local non-shared cache, then shared:
     ...
     * @since 2.6
     */
    public TypeSerializer findTypeSerializer(com.townmc.utils.jackson.databind.JavaType javaType) throws JsonMappingException {
     ...
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> findKeySerializer(com.townmc.utils.jackson.databind.JavaType keyType, com.townmc.utils.jackson.databind.BeanProperty property)
        throws JsonMappingException
    {
        com.townmc.utils.jackson.databind.JsonSerializer<Object> ser = _serializerFactory.createKeySerializer(_config, keyType, _keySerializer);
     ...
     * @since 2.7
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> findKeySerializer(Class<?> rawKeyType, com.townmc.utils.jackson.databind.BeanProperty property)
        throws JsonMappingException
    {
     ...
     * @since 2.0
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> getDefaultNullKeySerializer() {
     ...
     * @since 2.0
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> getDefaultNullValueSerializer() {
     ...
     * @since 2.0
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> findNullKeySerializer(com.townmc.utils.jackson.databind.JavaType serializationType,
                                                                                       com.townmc.utils.jackson.databind.BeanProperty property)
        throws JsonMappingException
    {
        return _nullKeySerializer;
     ...
     * @since 2.0
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> findNullValueSerializer(com.townmc.utils.jackson.databind.BeanProperty property)
        throws JsonMappingException {
        return _nullValueSerializer;
    }
     ...
     * although alternatively {@link com.townmc.utils.jackson.databind.ser.std.ToStringSerializer}
     * could be returned as well.
     *
     * @param unknownType Type for which no serializer is found
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<Object> getUnknownTypeSerializer(Class<?> unknownType) {
     ...
     * @since 2.5
     */
    public boolean isUnknownTypeSerializer(com.townmc.utils.jackson.databind.JsonSerializer<?> ser) {
     ...
     */
    public abstract com.townmc.utils.jackson.databind.JsonSerializer<Object> serializerInstance(Annotated annotated,
                                                                                             Object serDef)
        throws JsonMappingException;
     ...
     * @since 2.3
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<?> handlePrimaryContextualization(com.townmc.utils.jackson.databind.JsonSerializer<?> ser,
                                                                                           com.townmc.utils.jackson.databind.BeanProperty property)
        throws JsonMappingException
    {
        if (ser != null) {
     ...
     * @since 2.3
     */
    public com.townmc.utils.jackson.databind.JsonSerializer<?> handleSecondaryContextualization(com.townmc.utils.jackson.databind.JsonSerializer<?> ser,
                                                                                             com.townmc.utils.jackson.databind.BeanProperty property)
        throws JsonMappingException
    {
        if (ser != null) {
    ...
    @Override
    public <T> T reportBadDefinition(com.townmc.utils.jackson.databind.JavaType type, String msg) throws JsonMappingException {
     ...
     * @since 2.9
     */
    public <T> T reportBadDefinition(com.townmc.utils.jackson.databind.JavaType type, String msg, Throwable cause)
            throws JsonMappingException {
    ...
    @Override
    public JsonMappingException invalidTypeIdException(com.townmc.utils.jackson.databind.JavaType baseType, String typeId,
                                                       String extraDesc) {
    ...
    protected void _reportIncompatibleRootType(Object value, com.townmc.utils.jackson.databind.JavaType rootType) throws IOException
    {
     ...
     */
    protected com.townmc.utils.jackson.databind.JsonSerializer<Object> _findExplicitUntypedSerializer(Class<?> runtimeType)
        throws JsonMappingException
    {        
        // Fast lookup from local lookup thingy works?
        com.townmc.utils.jackson.databind.JsonSerializer<Object> ser = _knownSerializers.untypedValueSerializer(runtimeType);
        if (ser == null) {
            // If not, maybe shared map already has it?
     ...
     */
    protected com.townmc.utils.jackson.databind.JsonSerializer<Object> _createAndCacheUntypedSerializer(Class<?> rawType)
        throws JsonMappingException
    {
        com.townmc.utils.jackson.databind.JavaType fullType = _config.constructType(rawType);
        com.townmc.utils.jackson.databind.JsonSerializer<Object> ser;
        try {
    ...
    protected com.townmc.utils.jackson.databind.JsonSerializer<Object> _createAndCacheUntypedSerializer(com.townmc.utils.jackson.databind.JavaType type)
        throws JsonMappingException
    {        
        com.townmc.utils.jackson.databind.JsonSerializer<Object> ser;
        try {
     ...
     * @since 2.1
     */
    protected com.townmc.utils.jackson.databind.JsonSerializer<Object> _createUntypedSerializer(JavaType type)
        throws JsonMappingException
    {
        ...
        synchronized (_serializerCache) {
            ...
            return (com.townmc.utils.jackson.databind.JsonSerializer<Object>)_serializerFactory.createSerializer(this, type);
        }
    }
     ...
     */
    @SuppressWarnings("unchecked")
    protected com.townmc.utils.jackson.databind.JsonSerializer<Object> _handleContextualResolvable(com.townmc.utils.jackson.databind.JsonSerializer<?> ser,
    ...
    @SuppressWarnings("unchecked")
    protected com.townmc.utils.jackson.databind.JsonSerializer<Object> _handleResolvable(com.townmc.utils.jackson.databind.JsonSerializer<?> ser)
        throws JsonMappingException
    {
        if (ser instanceof ResolvableSerializer) {
            ((ResolvableSerializer) ser).resolve(this);

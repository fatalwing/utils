...
import com.townmc.utils.jackson.databind.PropertyNamingStrategy;
    ...
    implements Versioned, java.io.Serializable
{
     ...
     *<p> 
     * NOTE: method signature changed in 2.1, to return {@link com.townmc.utils.jackson.databind.PropertyName}
     * instead of String.
     */
    public com.townmc.utils.jackson.databind.PropertyName findRootName(AnnotatedClass ac) {
        return null;
    }
    ...
    */
    ...
    public TypeResolverBuilder<?> findTypeResolver(MapperConfig<?> config,
            AnnotatedClass ac, com.townmc.utils.jackson.databind.JavaType baseType) {
        return null;
    }
    ...
    public TypeResolverBuilder<?> findPropertyTypeResolver(MapperConfig<?> config,
            AnnotatedMember am, com.townmc.utils.jackson.databind.JavaType baseType) {
        return null;
    }
    ...
    public TypeResolverBuilder<?> findPropertyContentTypeResolver(MapperConfig<?> config,
            AnnotatedMember am, com.townmc.utils.jackson.databind.JavaType containerType) {
        return null;
    }
     ...
     * 
     * @return Wrapper name to use, if any, or {@link com.townmc.utils.jackson.databind.PropertyName#USE_DEFAULT}
     *   to indicate that no wrapper element should be used.
     * 
     * @since 2.1
     */
    public com.townmc.utils.jackson.databind.PropertyName findWrapperName(Annotated ann) { return null; }
     ...
     * @since 2.9
     */
    public List<com.townmc.utils.jackson.databind.PropertyName> findPropertyAliases(Annotated ann) { return null; }
     ...
     * @since 2.7
     */
    public com.townmc.utils.jackson.databind.JavaType refineSerializationType(final MapperConfig<?> config,
                                                                           final Annotated a, final com.townmc.utils.jackson.databind.JavaType baseType) throws com.townmc.utils.jackson.databind.JsonMappingException
    {
        return baseType;
    }
     ...
     */
    @Deprecated // since 2.7
    public Class<?> findSerializationKeyType(Annotated am, com.townmc.utils.jackson.databind.JavaType baseType) {
        return null;
    }
     ...
     */
    @Deprecated // since 2.7
    public Class<?> findSerializationContentType(Annotated am, com.townmc.utils.jackson.databind.JavaType baseType) {
        return null;
    }
     ...
     * {@link com.townmc.utils.jackson.databind.PropertyName#USE_DEFAULT}, which means "use default heuristics").
     * 
     ...
     * @since 2.1
     */
    public com.townmc.utils.jackson.databind.PropertyName findNameForSerialization(Annotated a) {
        return null;
    }
     ...
     * @since 2.7
     */
    public com.townmc.utils.jackson.databind.JavaType refineDeserializationType(final MapperConfig<?> config,
                                                                             final Annotated a, final com.townmc.utils.jackson.databind.JavaType baseType) throws JsonMappingException
    {
        return baseType;
    }
     ...
     */
    @Deprecated
    public Class<?> findDeserializationType(Annotated am, com.townmc.utils.jackson.databind.JavaType baseType) {
        return null;
    }
     ...
     */
    @Deprecated
    public Class<?> findDeserializationKeyType(Annotated am, com.townmc.utils.jackson.databind.JavaType baseKeyType) {
        return null;
    }

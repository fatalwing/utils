    ...
    implements java.io.Serializable
{
    ...
    public UnwrappingBeanSerializer(UnwrappingBeanSerializer src,
            com.townmc.utils.jackson.databind.ser.impl.ObjectIdWriter objectIdWriter) {
        super(src, objectIdWriter);
        _nameTransformer = src._nameTransformer;
    }

    public UnwrappingBeanSerializer(UnwrappingBeanSerializer src,
                                    com.townmc.utils.jackson.databind.ser.impl.ObjectIdWriter objectIdWriter, Object filterId) {

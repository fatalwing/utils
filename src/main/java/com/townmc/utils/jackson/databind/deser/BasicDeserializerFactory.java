...
import com.townmc.utils.jackson.databind.cfg.DeserializerFactoryConfig;
import com.townmc.utils.jackson.databind.cfg.HandlerInstantiator;
import com.townmc.utils.jackson.databind.deser.AbstractDeserializer;
import com.townmc.utils.jackson.databind.deser.BeanDeserializerModifier;
import com.townmc.utils.jackson.databind.deser.CreatorProperty;
import com.townmc.utils.jackson.databind.deser.DeserializerFactory;
import com.townmc.utils.jackson.databind.deser.Deserializers;
import com.townmc.utils.jackson.databind.deser.KeyDeserializers;
...
import com.townmc.utils.jackson.databind.deser.impl.CreatorCollector;
import com.townmc.utils.jackson.databind.deser.std.*;
import com.townmc.utils.jackson.databind.ext.OptionalHandlerFactory;
...
public abstract class BasicDeserializerFactory
    extends com.townmc.utils.jackson.databind.deser.DeserializerFactory
    implements java.io.Serializable
{
    ...
    static {
        ...
        _mapFallbacks.put(ConcurrentNavigableMap.class.getName(),
    ...
    protected abstract com.townmc.utils.jackson.databind.deser.DeserializerFactory withConfig(DeserializerFactoryConfig config);
     ...
     */
    @Override
    public final com.townmc.utils.jackson.databind.deser.DeserializerFactory withAdditionalDeserializers(com.townmc.utils.jackson.databind.deser.Deserializers additional) {
        return withConfig(_factoryConfig.withAdditionalDeserializers(additional));
    }

    /**
     * Convenience method for creating a new factory instance with additional
     * {@link com.townmc.utils.jackson.databind.deser.KeyDeserializers}.
     */
    @Override
    public final com.townmc.utils.jackson.databind.deser.DeserializerFactory withAdditionalKeyDeserializers(com.townmc.utils.jackson.databind.deser.KeyDeserializers additional) {
     ...
     */
    @Override
    public final com.townmc.utils.jackson.databind.deser.DeserializerFactory withDeserializerModifier(BeanDeserializerModifier modifier) {
     ...
     */
    @Override
    public final com.townmc.utils.jackson.databind.deser.DeserializerFactory withAbstractTypeResolver(AbstractTypeResolver resolver) {
        return withConfig(_factoryConfig.withAbstractTypeResolver(resolver));
    }

    /**
     * Convenience method for creating a new factory instance with additional
     * {@link com.townmc.utils.jackson.databind.deser.ValueInstantiators}.
     */
    @Override
    public final DeserializerFactory withValueInstantiators(com.townmc.utils.jackson.databind.deser.ValueInstantiators instantiators) {
     ...
     */
    @Override
    public com.townmc.utils.jackson.databind.deser.ValueInstantiator findValueInstantiator(DeserializationContext ctxt,
                                                                                        BeanDescription beanDesc)
        throws JsonMappingException
    {
        final DeserializationConfig config = ctxt.getConfig();

        com.townmc.utils.jackson.databind.deser.ValueInstantiator instantiator = null;
    ...
    private com.townmc.utils.jackson.databind.deser.ValueInstantiator _findStdValueInstantiator(DeserializationConfig config,
                                                                                             BeanDescription beanDesc)
        throws JsonMappingException
    {
    ...
    /**
     * Method that will construct standard default {@link com.townmc.utils.jackson.databind.deser.ValueInstantiator}
     * using annotations (like @JsonCreator) and visibility rules
     */
    protected com.townmc.utils.jackson.databind.deser.ValueInstantiator _constructDefaultValueInstantiator(DeserializationContext ctxt,
                                                                                                        BeanDescription beanDesc)
        throws JsonMappingException
    {
    ...
    public com.townmc.utils.jackson.databind.deser.ValueInstantiator _valueInstantiatorInstance(DeserializationConfig config,
        ...
        throws JsonMappingException
    {
        ...
        com.townmc.utils.jackson.databind.deser.ValueInstantiator inst;
        
        if (instDef instanceof com.townmc.utils.jackson.databind.deser.ValueInstantiator) {
            return (com.townmc.utils.jackson.databind.deser.ValueInstantiator) instDef;
        }
        ...
        if (!com.townmc.utils.jackson.databind.deser.ValueInstantiator.class.isAssignableFrom(instClass)) {
        ...
        return (com.townmc.utils.jackson.databind.deser.ValueInstantiator) ClassUtil.createInstance(instClass,
        ...
        throws JsonMappingException
    {
        ...
        for (AnnotatedConstructor ctor : beanDesc.getConstructors()) {
            ...
            if (argCount == 1) {
                ...
                if (useProps) {
                    com.townmc.utils.jackson.databind.deser.SettableBeanProperty[] properties = new com.townmc.utils.jackson.databind.deser.SettableBeanProperty[1];
            ...
            com.townmc.utils.jackson.databind.deser.SettableBeanProperty[] properties = new com.townmc.utils.jackson.databind.deser.SettableBeanProperty[argCount];
            ...
            List<AnnotatedConstructor> implicitCtors) throws JsonMappingException
    {
        ...
        com.townmc.utils.jackson.databind.deser.SettableBeanProperty[] foundProps = null;
        ...
        if (found != null) {
            ...
            for (com.townmc.utils.jackson.databind.deser.SettableBeanProperty prop : foundProps) {
     ...
     * factory method)
     */
    protected com.townmc.utils.jackson.databind.deser.SettableBeanProperty constructCreatorProperty(DeserializationContext ctxt,
        ...
        throws JsonMappingException
    {
        ...
        com.townmc.utils.jackson.databind.deser.SettableBeanProperty prop = new CreatorProperty(name, type, property.getWrapperName(),
        ...
        if (deser == null) {
            if (type.isInterface() || type.isAbstract()) {
                ...
                if (implType == null) {
                    ...
                    deser = com.townmc.utils.jackson.databind.deser.AbstractDeserializer.constructForNonPOJO(beanDesc);
                } else {
                    type = implType;
            ...
            if (deser == null) {
                com.townmc.utils.jackson.databind.deser.ValueInstantiator inst = findValueInstantiator(ctxt, beanDesc);
        ...
        throws JsonMappingException
    {
        ...
        if (deser == null) {
            com.townmc.utils.jackson.databind.deser.ValueInstantiator valueInstantiator = _constructDefaultValueInstantiator(ctxt, beanDesc);
    ...
    protected JsonDeserializer<?> _findCustomTreeNodeDeserializer(Class<? extends JsonNode> type,
        ...
        throws JsonMappingException
    {
        for (com.townmc.utils.jackson.databind.deser.Deserializers d  : _factoryConfig.deserializers()) {

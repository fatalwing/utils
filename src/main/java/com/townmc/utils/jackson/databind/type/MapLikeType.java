 ...
 */
public class MapLikeType extends com.townmc.utils.jackson.databind.type.TypeBase {
    ...
    * Life-cycle
     ...
     * @since 2.7
     */
    protected MapLikeType(com.townmc.utils.jackson.databind.type.TypeBase base, JavaType keyT, JavaType valueT) {
        super(base);
        _keyType = keyT;
        _valueType = valueT;
    }

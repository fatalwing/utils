...
import com.townmc.utils.jackson.databind.deser.BeanDeserializerBuilder;
import com.townmc.utils.jackson.databind.deser.CreatorProperty;
import com.townmc.utils.jackson.databind.deser.DeserializerCache;
...
import com.townmc.utils.jackson.databind.deser.impl.*;
import com.townmc.utils.jackson.databind.deser.std.ThrowableDeserializer;
...
import com.townmc.utils.jackson.databind.util.SimpleBeanPropertyDefinition;
    ...
    implements java.io.Serializable // since 2.1
{
        ...
        throws JsonMappingException
    {
        ...
        com.townmc.utils.jackson.databind.deser.ValueInstantiator valueInstantiator;
        ...
        com.townmc.utils.jackson.databind.deser.BeanDeserializerBuilder builder = constructBeanDeserializerBuilder(ctxt, beanDesc);
        ...
        throws JsonMappingException
    {
        ...
        final DeserializationConfig config = ctxt.getConfig();
        com.townmc.utils.jackson.databind.deser.BeanDeserializerBuilder builder = constructBeanDeserializerBuilder(ctxt, builderDesc);
        builder.setValueInstantiator(valueInstantiator);
    ...
    protected void addObjectIdReader(DeserializationContext ctxt,
            BeanDescription beanDesc, com.townmc.utils.jackson.databind.deser.BeanDeserializerBuilder builder)
        throws JsonMappingException
    {
        ...
        JavaType idType;
        com.townmc.utils.jackson.databind.deser.SettableBeanProperty idProp;
        ...
        throws JsonMappingException
    {
        ...
        if (am != null) { // should never be null
            ...
            com.townmc.utils.jackson.databind.deser.SettableBeanProperty prop = constructSettableProperty(ctxt, beanDesc, propDef,
        ...
        */
         ...
         */
        if (deserializer instanceof com.townmc.utils.jackson.databind.deser.BeanDeserializer) {
    ...
    /**
     * Overridable method that constructs a {@link com.townmc.utils.jackson.databind.deser.BeanDeserializerBuilder}
     * which is used to accumulate information needed to create deserializer
     * instance.
     */
    protected com.townmc.utils.jackson.databind.deser.BeanDeserializerBuilder constructBeanDeserializerBuilder(DeserializationContext ctxt,
                                                                                                            BeanDescription beanDesc) {
        return new com.townmc.utils.jackson.databind.deser.BeanDeserializerBuilder(beanDesc, ctxt);
    }
        ...
        throws JsonMappingException
    {
        ...
        final com.townmc.utils.jackson.databind.deser.SettableBeanProperty[] creatorProps = isConcrete
        ...
        for (BeanPropertyDefinition propDef : propDefs) {
            com.townmc.utils.jackson.databind.deser.SettableBeanProperty prop = null;
            ...
            if (hasCreatorProps && propDef.hasConstructorParameter()) {
                ...
                com.townmc.utils.jackson.databind.deser.CreatorProperty cprop = null;
                if (creatorProps != null) {
                    for (com.townmc.utils.jackson.databind.deser.SettableBeanProperty cp : creatorProps) {
                        if (name.equals(cp.getName()) && (cp instanceof com.townmc.utils.jackson.databind.deser.CreatorProperty)) {
...
name, ((AnnotatedParameter) m).getIndex());
    ...
    /**
     * Method called to construct fallback {@link com.townmc.utils.jackson.databind.deser.SettableAnyProperty}
     ...
     */
    @SuppressWarnings("unchecked")
    protected com.townmc.utils.jackson.databind.deser.SettableAnyProperty constructAnySetter(DeserializationContext ctxt,
     ...
     */
    protected com.townmc.utils.jackson.databind.deser.SettableBeanProperty constructSettableProperty(DeserializationContext ctxt,
        ...
        throws JsonMappingException
    {
        ...
        com.townmc.utils.jackson.databind.deser.SettableBeanProperty prop;
        if (mutator instanceof AnnotatedMethod) {
     ...
     * the given setter method.
     */
    protected com.townmc.utils.jackson.databind.deser.SettableBeanProperty constructSetterlessProperty(DeserializationContext ctxt,
                                                                                                    BeanDescription beanDesc, BeanPropertyDefinition propDef)
        throws JsonMappingException
    {

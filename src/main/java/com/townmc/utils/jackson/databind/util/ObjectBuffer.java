...
public final class ObjectBuffer
{
    ...
    private com.townmc.utils.jackson.databind.util.LinkedNode<Object[]> _head;

    private com.townmc.utils.jackson.databind.util.LinkedNode<Object[]> _tail;
    ...
    {
        com.townmc.utils.jackson.databind.util.LinkedNode<Object[]> next = new com.townmc.utils.jackson.databind.util.LinkedNode<Object[]>(fullChunk, null);
    ...
    {
        for (com.townmc.utils.jackson.databind.util.LinkedNode<Object[]> n = _head; n != null; n = n.next()) {
            Object[] curr = n.value();

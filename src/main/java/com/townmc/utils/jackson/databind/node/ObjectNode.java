    ...
    extends ContainerNode<ObjectNode>
{
    ...
    @Override
    public com.townmc.utils.jackson.databind.node.ArrayNode withArray(String propertyName)
    {
        JsonNode n = _children.get(propertyName);
        if (n != null) {
            if (n instanceof com.townmc.utils.jackson.databind.node.ArrayNode) {
                return (com.townmc.utils.jackson.databind.node.ArrayNode) n;
            }
            throw new UnsupportedOperationException("Property '" + propertyName
                + "' has value that is not of type ArrayNode (but " + n
                .getClass().getName() + ")");
        }
        com.townmc.utils.jackson.databind.node.ArrayNode result = arrayNode();
        _children.put(propertyName, result);
        return result;
    }
     ...
     *   to a {@link com.townmc.utils.jackson.databind.node.NullNode} first  (to remove field entry, call
     *   {@link #remove} instead)
     *
     ...
     */
    public com.townmc.utils.jackson.databind.node.ArrayNode putArray(String fieldName)
    {
     ...
     *  "smaller" (like {@link com.townmc.utils.jackson.databind.node.IntNode}) in cases where value fits within
     *  range of a smaller integral numeric value.
     * 
     * @return This node (to allow chaining)
     */

...
import com.townmc.utils.jackson.databind.deser.std.StdDelegatingDeserializer;
import com.townmc.utils.jackson.databind.deser.std.StdDeserializer;
import com.townmc.utils.jackson.databind.exc.IgnoredPropertyException;
...
public abstract class BeanDeserializerBase
    ...
    implements ContextualDeserializer, ResolvableDeserializer,
        com.townmc.utils.jackson.databind.deser.ValueInstantiator.Gettable, // since 2.9
        java.io.Serializable // since 2.1
{
     ...
     */
    protected final com.townmc.utils.jackson.databind.deser.ValueInstantiator _valueInstantiator;
...
"Cannot handle managed/back reference '%s': back reference type (%s) not compatible with managed type (%s)",
            ...
            SettableBeanProperty prop)
    {
        ...
        if (deser instanceof BeanDeserializerBase) {
            ...
            com.townmc.utils.jackson.databind.deser.ValueInstantiator vi = bd.getValueInstantiator();

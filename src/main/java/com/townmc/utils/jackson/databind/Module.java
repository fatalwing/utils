...
import com.townmc.utils.jackson.databind.cfg.MutableConfigOverride;
    ...
    implements Versioned
{
     ...
     * (see {@link com.townmc.utils.jackson.databind.MapperFeature#IGNORE_DUPLICATE_MODULE_REGISTRATIONS})
    ...
    public static interface SetupContext
    {
        ...
        /**
         * Method that module can use to register additional {@link com.townmc.utils.jackson.databind.deser.ValueInstantiator}s,
         * by adding {@link ValueInstantiators} object that gets called when 
         * instantatiator is needed by a deserializer.
         * 
         * @param instantiators Object that can provide {@link com.townmc.utils.jackson.databind.deser.ValueInstantiator}s for

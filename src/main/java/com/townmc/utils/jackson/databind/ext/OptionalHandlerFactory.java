...
public class OptionalHandlerFactory implements java.io.Serializable
{
    ...
    private final static String SERIALIZERS_FOR_JAVAX_XML = "com.townmc.utils.jackson.databind.ext.CoreXMLSerializers";
    private final static String DESERIALIZERS_FOR_JAVAX_XML = "com.townmc.utils.jackson.databind.ext.CoreXMLDeserializers";
...
//    private final static String CLASS_NAME_DOM_DOCUMENT = "org.w3c.dom.Document";
    private final static String SERIALIZER_FOR_DOM_NODE = "com.townmc.utils.jackson.databind.ext.DOMSerializer";
    private final static String DESERIALIZER_FOR_DOM_DOCUMENT = "com.townmc.utils.jackson.databind.ext.DOMDeserializer$DocumentDeserializer";
    private final static String DESERIALIZER_FOR_DOM_NODE = "com.townmc.utils.jackson.databind.ext.DOMDeserializer$NodeDeserializer";
    ...
    private static final com.townmc.utils.jackson.databind.ext.Java7Support _jdk7Helper;
    static {
        com.townmc.utils.jackson.databind.ext.Java7Support x = null;
        try {

...
import com.townmc.utils.jackson.databind.type.TypeBindings;
...
public class BasicBeanDescription extends BeanDescription
{
     ...
     */
    final protected com.townmc.utils.jackson.databind.introspect.AnnotatedClass _classInfo;
     ...
     */
    protected com.townmc.utils.jackson.databind.introspect.ObjectIdInfo _objectIdInfo;
    ...
    protected BasicBeanDescription(POJOPropertiesCollector coll,
            JavaType type, com.townmc.utils.jackson.databind.introspect.AnnotatedClass classDef)
    {
        super(type);
        _propCollector = coll;
    ...
    protected BasicBeanDescription(MapperConfig<?> config,
                                   JavaType type, com.townmc.utils.jackson.databind.introspect.AnnotatedClass classDef, List<BeanPropertyDefinition> props)
    {
        super(type);
        _propCollector = null;
        _config = config;
    ...
    public static BasicBeanDescription forOtherUse(MapperConfig<?> config,
            JavaType type, com.townmc.utils.jackson.databind.introspect.AnnotatedClass ac)
    {
    ...
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMethod findJsonValueMethod() {
        return (_propCollector == null) ? null
                : _propCollector.getJsonValueMethod();
    }

    @Override // since 2.9
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMember findJsonValueAccessor() {
        return (_propCollector == null) ? null
    ...
    @Override
    public com.townmc.utils.jackson.databind.introspect.AnnotatedConstructor findDefaultConstructor() {
        return _classInfo.getDefaultConstructor();
    }

    @Override
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMember findAnySetterAccessor() throws IllegalArgumentException
    {
        if (_propCollector != null) {
            com.townmc.utils.jackson.databind.introspect.AnnotatedMethod anyMethod = _propCollector.getAnySetterMethod();
            if (anyMethod != null) {
...
anyMethod.getName(), type.getName()));
            ...
            com.townmc.utils.jackson.databind.introspect.AnnotatedMember anyField = _propCollector.getAnySetterField();
            if (anyField != null) {
...
anyField.getName()));
    ...
    @Override
    public Map<Object, com.townmc.utils.jackson.databind.introspect.AnnotatedMember> findInjectables() {
        if (_propCollector != null) {
    ...
    @Override
    public List<com.townmc.utils.jackson.databind.introspect.AnnotatedConstructor> getConstructors() {
        return _classInfo.getConstructors();
    }

    @Override
    public Object instantiateBean(boolean fixAccess) {
        com.townmc.utils.jackson.databind.introspect.AnnotatedConstructor ac = _classInfo.getDefaultConstructor();
        if (ac == null) {
            return null;
        }
        if (fixAccess) {
    ...
    @Override
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMethod findMethod(String name, Class<?>[] paramTypes) {
     ...
     * implements {@link com.townmc.utils.jackson.annotation.JsonAnyGetter}.
     * If no such method exists null is returned.
     * If more than one are found, an exception is thrown.
     */
    @Override
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMember findAnyGetter() throws IllegalArgumentException
    {
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember anyGetter = (_propCollector == null) ? null
    ...
    @Deprecated // since 2.9
    @Override
    public Map<String, com.townmc.utils.jackson.databind.introspect.AnnotatedMember> findBackReferenceProperties()
    {
    ...
    @Override
    public List<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod> getFactoryMethods()
    {
        // must filter out anything that clearly is not a factory method
        List<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod> candidates = _classInfo.getFactoryMethods();
        if (candidates.isEmpty()) {
            return candidates;
        }
        ArrayList<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod> result = new ArrayList<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod>();
        for (com.townmc.utils.jackson.databind.introspect.AnnotatedMethod am : candidates) {
    ...
    public Method findFactoryMethod(Class<?>... expArgTypes)
    {
        ...
        for (com.townmc.utils.jackson.databind.introspect.AnnotatedMethod am : _classInfo.getFactoryMethods()) {
     ...
     */
    @Deprecated
    public LinkedHashMap<String, com.townmc.utils.jackson.databind.introspect.AnnotatedField> _findPropertyFields(
            Collection<String> ignoredProperties, boolean forSerialization)
    {
        LinkedHashMap<String, com.townmc.utils.jackson.databind.introspect.AnnotatedField> results = new LinkedHashMap<String, com.townmc.utils.jackson.databind.introspect.AnnotatedField>();
        for (BeanPropertyDefinition property : _properties()) {

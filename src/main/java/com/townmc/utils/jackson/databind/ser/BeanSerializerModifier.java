...
import com.townmc.utils.jackson.databind.ser.BeanSerializerFactory;
import com.townmc.utils.jackson.databind.type.*;

/**
 * Abstract class that defines API for objects that can be registered (for {@link com.townmc.utils.jackson.databind.ser.BeanSerializerFactory}
 * to participate in constructing {@link com.townmc.utils.jackson.databind.ser.BeanSerializer} instances.
 * This is typically done by modules that want alter some aspects of serialization
 * process; and is preferable to sub-classing of {@link com.townmc.utils.jackson.databind.ser.BeanSerializerFactory}.
 *<p>
 ...
 *     factory creates default {@link com.townmc.utils.jackson.databind.ser.BeanSerializer} instance and passes
...
{
    /**
     * Method called by {@link com.townmc.utils.jackson.databind.ser.BeanSerializerFactory} with tentative set
     ...
     * modifiers.
     */
    public List<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> changeProperties(SerializationConfig config,
                                                                                        BeanDescription beanDesc, List<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> beanProperties) {
        return beanProperties;
    }

    /**
     * Method called by {@link com.townmc.utils.jackson.databind.ser.BeanSerializerFactory} with set of properties
     ...
     * modifiers.
     */
    public List<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> orderProperties(SerializationConfig config,
                                                                                       BeanDescription beanDesc, List<BeanPropertyWriter> beanProperties) {
        return beanProperties;
    }

    /**
     * Method called by {@link com.townmc.utils.jackson.databind.ser.BeanSerializerFactory} after collecting all information
     ...
     * some modifications.
     */
    public com.townmc.utils.jackson.databind.ser.BeanSerializerBuilder updateBuilder(SerializationConfig config,

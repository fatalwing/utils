 ...
 * {@link com.townmc.utils.jackson.databind.introspect.AnnotatedClass} instances.
 *
 * @since 2.9
 */
public class AnnotatedClassResolver
{
    private final static Annotations NO_ANNOTATIONS = com.townmc.utils.jackson.databind.introspect.AnnotationCollector.emptyAnnotations();
    ...
    public static com.townmc.utils.jackson.databind.introspect.AnnotatedClass resolve(MapperConfig<?> config, JavaType forType,
                                                                                   MixInResolver r)
    {
    ...
    public static com.townmc.utils.jackson.databind.introspect.AnnotatedClass resolveWithoutSuperTypes(MapperConfig<?> config, Class<?> forType) {
        return resolveWithoutSuperTypes(config, forType, config);
    }

    public static com.townmc.utils.jackson.databind.introspect.AnnotatedClass resolveWithoutSuperTypes(MapperConfig<?> config, JavaType forType,
                                                                                                    MixInResolver r)
    {
        if (forType.isArrayType() && skippableArray(config, forType.getRawClass())) {
            return createArrayType(config, forType.getRawClass());
     ...
     */
    static com.townmc.utils.jackson.databind.introspect.AnnotatedClass createPrimordial(Class<?> raw) {
        return new com.townmc.utils.jackson.databind.introspect.AnnotatedClass(raw);
    }
     ...
     */
    static com.townmc.utils.jackson.databind.introspect.AnnotatedClass createArrayType(MapperConfig<?> config, Class<?> raw) {
        return new com.townmc.utils.jackson.databind.introspect.AnnotatedClass(raw);
    }

    com.townmc.utils.jackson.databind.introspect.AnnotatedClass resolveFully() {
        List<JavaType> superTypes = ClassUtil.findSuperTypes(_type, null, false);
        return new com.townmc.utils.jackson.databind.introspect.AnnotatedClass(_type, _class, superTypes, _primaryMixin,
                resolveClassAnnotations(superTypes),
                _bindings, _intr, _mixInResolver, _config.getTypeFactory());

    }

    com.townmc.utils.jackson.databind.introspect.AnnotatedClass resolveWithoutSuperTypes() {
    ...
    private Annotations resolveClassAnnotations(List<JavaType> superTypes)
    {
        ...
        com.townmc.utils.jackson.databind.introspect.AnnotationCollector resolvedCA = com.townmc.utils.jackson.databind.introspect.AnnotationCollector.emptyCollector();
    ...
    private com.townmc.utils.jackson.databind.introspect.AnnotationCollector _addClassMixIns(com.townmc.utils.jackson.databind.introspect.AnnotationCollector annotations,
    ...
    private com.townmc.utils.jackson.databind.introspect.AnnotationCollector _addAnnotationsIfNotPresent(com.townmc.utils.jackson.databind.introspect.AnnotationCollector c,
                                                                                                      Annotation[] anns)
    {
        if (anns != null) {
    ...
    private com.townmc.utils.jackson.databind.introspect.AnnotationCollector _addFromBundleIfNotPresent(AnnotationCollector c,
                                                                                                     Annotation bundle)
    {

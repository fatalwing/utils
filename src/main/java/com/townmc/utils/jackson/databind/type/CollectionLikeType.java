 ...
 */
public class CollectionLikeType extends com.townmc.utils.jackson.databind.type.TypeBase
{
    ...
    protected CollectionLikeType(Class<?> collT, com.townmc.utils.jackson.databind.type.TypeBindings bindings,
     ...
     * @since 2.7
     */
    protected CollectionLikeType(com.townmc.utils.jackson.databind.type.TypeBase base, JavaType elemT)
    {
        super(base);
        _elementType = elemT;
    }
     ...
     * @since 2.7
     */
    public static CollectionLikeType construct(Class<?> rawType, com.townmc.utils.jackson.databind.type.TypeBindings bindings,
            JavaType superClass, JavaType[] superInts, JavaType elemT) {
    ...
    public static CollectionLikeType construct(Class<?> rawType, JavaType elemT) {
        ...
        com.townmc.utils.jackson.databind.type.TypeBindings bindings;
        if ((vars == null) || (vars.length != 1)) {
            bindings = com.townmc.utils.jackson.databind.type.TypeBindings.emptyBindings();
        } else {
            bindings = com.townmc.utils.jackson.databind.type.TypeBindings.create(rawType, elemT);
        }

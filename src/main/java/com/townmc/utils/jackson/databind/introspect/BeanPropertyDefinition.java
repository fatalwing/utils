    ...
    implements Named
{
    ...
    public abstract com.townmc.utils.jackson.databind.introspect.AnnotatedMethod getGetter();
    public abstract AnnotatedMethod getSetter();
    public abstract AnnotatedField getField();
    public abstract com.townmc.utils.jackson.databind.introspect.AnnotatedParameter getConstructorParameter();
     ...
     */
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMember getAccessor()
    {
     ...
     * Null if no such member exists.
     */
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMember getMutator() {
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember acc = getConstructorParameter();
        if (acc == null) {
            acc = getSetter();
            if (acc == null) {
                acc = getField();
     ...
     * @since 2.3
     */
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMember getNonConstructorMutator() {
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember m = getSetter();
        if (m == null) {
            m = getField();
        }
        return m;

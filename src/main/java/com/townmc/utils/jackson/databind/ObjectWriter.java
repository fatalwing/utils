        ...
        Serializable // since 2.1
{
     ...
     */
    protected ObjectWriter(com.townmc.utils.jackson.databind.ObjectMapper mapper, SerializationConfig config,
    ...
    /**
     * Alternative constructor for initial instantiation by {@link com.townmc.utils.jackson.databind.ObjectMapper}
     */
    protected ObjectWriter(com.townmc.utils.jackson.databind.ObjectMapper mapper, SerializationConfig config)
    {
        _config = config;
     ...
     * @since 2.5
     */
    public ObjectWriter forType(com.townmc.utils.jackson.databind.JavaType rootType) {
    ...
    public ObjectWriter forType(Class<?> rootType) {
        if (rootType == Object.class) {
            return forType((com.townmc.utils.jackson.databind.JavaType) null);
        }
    ...
    public ObjectWriter withType(com.townmc.utils.jackson.databind.JavaType rootType) {
     ...
     * @since 2.2
     */
    public void acceptJsonFormatVisitor(com.townmc.utils.jackson.databind.JavaType type, JsonFormatVisitorWrapper visitor) throws JsonMappingException
    {
        if (type == null) {
        ...
        implements Serializable
    {
         ...
         */
        private final com.townmc.utils.jackson.databind.JavaType rootType;
        ...
        private Prefetch(com.townmc.utils.jackson.databind.JavaType rootT,

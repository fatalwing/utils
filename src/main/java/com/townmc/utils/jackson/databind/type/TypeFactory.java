package com.townmc.utils.jackson.databind.type;
...
import com.townmc.utils.jackson.databind.type.ArrayType;
import com.townmc.utils.jackson.databind.type.ClassStack;
import com.townmc.utils.jackson.databind.type.MapLikeType;
import com.townmc.utils.jackson.databind.type.MapType;
import com.townmc.utils.jackson.databind.type.SimpleType;
import com.townmc.utils.jackson.databind.type.TypeParser;
import com.townmc.utils.jackson.databind.util.ArrayBuilders;
 ...
 *<p>
 * Instances of this class are accessible using {@link com.townmc.utils.jackson.databind.ObjectMapper}
 * as well as many objects it constructs (like
* {@link com.townmc.utils.jackson.databind.DeserializationConfig} and
 * {@link com.townmc.utils.jackson.databind.SerializationConfig})),
    ...
    implements java.io.Serializable
{
    ...
    protected final static com.townmc.utils.jackson.databind.type.SimpleType CORE_TYPE_BOOL = new com.townmc.utils.jackson.databind.type.SimpleType(CLS_BOOL);
    protected final static com.townmc.utils.jackson.databind.type.SimpleType CORE_TYPE_INT = new com.townmc.utils.jackson.databind.type.SimpleType(CLS_INT);
    protected final static com.townmc.utils.jackson.databind.type.SimpleType CORE_TYPE_LONG = new com.townmc.utils.jackson.databind.type.SimpleType(CLS_LONG);

    // and as to String... well, for now, ignore its super types
    protected final static com.townmc.utils.jackson.databind.type.SimpleType CORE_TYPE_STRING = new com.townmc.utils.jackson.databind.type.SimpleType(CLS_STRING);

    // @since 2.7
    protected final static com.townmc.utils.jackson.databind.type.SimpleType CORE_TYPE_OBJECT = new com.townmc.utils.jackson.databind.type.SimpleType(CLS_OBJECT);
     ...
     * @since 2.7
     */
    protected final static com.townmc.utils.jackson.databind.type.SimpleType CORE_TYPE_COMPARABLE = new com.townmc.utils.jackson.databind.type.SimpleType(CLS_COMPARABLE);
     ...
     * @since 2.7
     */
    protected final static com.townmc.utils.jackson.databind.type.SimpleType CORE_TYPE_ENUM = new com.townmc.utils.jackson.databind.type.SimpleType(CLS_ENUM);
     ...
     * @since 2.7
     */
    protected final static com.townmc.utils.jackson.databind.type.SimpleType CORE_TYPE_CLASS = new com.townmc.utils.jackson.databind.type.SimpleType(CLS_CLASS);
    ...
    protected final com.townmc.utils.jackson.databind.type.TypeParser _parser;
    ...
    protected TypeFactory(LRUMap<Object,JavaType> typeCache) {
        ...
        _parser = new com.townmc.utils.jackson.databind.type.TypeParser(this);
        _modifiers = null;
        _classLoader = null;
    }
    ...
    /**
     * Method for constructing an {@link com.townmc.utils.jackson.databind.type.ArrayType}.
     *<p>
     * NOTE: type modifiers are NOT called on array type itself; but are called
     * for element type (and other contained types)
     */
    public com.townmc.utils.jackson.databind.type.ArrayType constructArrayType(Class<?> elementType) {
        return com.townmc.utils.jackson.databind.type.ArrayType.construct(_fromAny(null, elementType, null), null);
    }
     ...
     * for contained types.
     */
    public com.townmc.utils.jackson.databind.type.ArrayType constructArrayType(JavaType elementType) {
        return com.townmc.utils.jackson.databind.type.ArrayType.construct(elementType, null);
    }
    ...
    /**
     * Method for constructing a {@link com.townmc.utils.jackson.databind.type.MapType} instance
     *<p>
     * NOTE: type modifiers are NOT called on constructed type itself; but are called
     * for contained types.
     */
    public com.townmc.utils.jackson.databind.type.MapType constructMapType(Class<? extends Map> mapClass,
     ...
     * for contained types.
     */
    public com.townmc.utils.jackson.databind.type.MapType constructMapType(Class<? extends Map> mapClass, JavaType keyType, JavaType valueType) {
        TypeBindings bindings = TypeBindings.createIfNeeded(mapClass, new JavaType[] { keyType, valueType });
        com.townmc.utils.jackson.databind.type.MapType result = (com.townmc.utils.jackson.databind.type.MapType) _fromClass(null, mapClass, bindings);
        // 17-May-2017, tatu: As per [databind#1415], we better verify bound values if (but only if)
        //    type being resolved was non-generic (i.e.element type was ignored)
        if (bindings.isEmpty()) {
    ...
    /**
     * Method for constructing a {@link com.townmc.utils.jackson.databind.type.MapLikeType} instance
     *<p>
     * NOTE: type modifiers are NOT called on constructed type itself; but are called
     * for contained types.
     */
    public com.townmc.utils.jackson.databind.type.MapLikeType constructMapLikeType(Class<?> mapClass, Class<?> keyClass, Class<?> valueClass) {
     ...
     * for contained types.
     */
    public com.townmc.utils.jackson.databind.type.MapLikeType constructMapLikeType(Class<?> mapClass, JavaType keyType, JavaType valueType) {
        ...
        if (type instanceof com.townmc.utils.jackson.databind.type.MapLikeType) {
            return (com.townmc.utils.jackson.databind.type.MapLikeType) type;
        }
        return com.townmc.utils.jackson.databind.type.MapLikeType.upgradeFrom(type, keyType, valueType);
    }
     ...
     * This method should only be used if parameterization is completely unavailable.
     */
    public com.townmc.utils.jackson.databind.type.MapType constructRawMapType(Class<? extends Map> mapClass) {
            ...
            JavaType superClass, JavaType[] superInterfaces)
    {
        ...
        return com.townmc.utils.jackson.databind.type.MapType.construct(rawClass, bindings, superClass, superInterfaces, kt, vt);
    }
    ...
    /**
     * Factory method that is to create a new {@link com.townmc.utils.jackson.databind.type.SimpleType} with no
     * checks whatsoever. Default implementation calls the single argument
     * constructor of {@link com.townmc.utils.jackson.databind.type.SimpleType}.
     *
     * @since 2.7
     */
     ...
     */
    protected JavaType _fromAny(com.townmc.utils.jackson.databind.type.ClassStack context, Type type, TypeBindings bindings)
    {
        JavaType resultType;
     ...
     */
    protected JavaType _fromClass(com.townmc.utils.jackson.databind.type.ClassStack context, Class<?> rawType, TypeBindings bindings)
    {
        ...
        if (context == null) {
            context = new com.townmc.utils.jackson.databind.type.ClassStack(rawType);
        } else {
            com.townmc.utils.jackson.databind.type.ClassStack prev = context.find(rawType);
            if (prev != null) {
        ...
        if (rawType.isArray()) {
            result = com.townmc.utils.jackson.databind.type.ArrayType.construct(_fromAny(context, rawType.getComponentType(), bindings),
                    bindings);
        } else {
    ...
    protected JavaType _resolveSuperClass(com.townmc.utils.jackson.databind.type.ClassStack context, Class<?> rawType, TypeBindings parentBindings)
    {
    ...
    protected JavaType[] _resolveSuperInterfaces(com.townmc.utils.jackson.databind.type.ClassStack context, Class<?> rawType, TypeBindings parentBindings)
    {
     ...
     */
    protected JavaType _fromWellKnownClass(com.townmc.utils.jackson.databind.type.ClassStack context, Class<?> rawType, TypeBindings bindings,
                                           JavaType superClass, JavaType[] superInterfaces)
    {
        if (bindings == null) {
            bindings = EMPTY_BINDINGS;
    ...
    protected JavaType _fromWellKnownInterface(com.townmc.utils.jackson.databind.type.ClassStack context, Class<?> rawType, TypeBindings bindings,
                                               JavaType superClass, JavaType[] superInterfaces)
    {
     ...
     */
    protected JavaType _fromParamType(com.townmc.utils.jackson.databind.type.ClassStack context, ParameterizedType ptype,
    ...
    protected JavaType _fromArrayType(com.townmc.utils.jackson.databind.type.ClassStack context, GenericArrayType type, TypeBindings bindings)
    {
    ...
    protected JavaType _fromVariable(com.townmc.utils.jackson.databind.type.ClassStack context, TypeVariable<?> var, TypeBindings bindings)
    {

...
public interface JsonMapFormatVisitor extends JsonFormatVisitorWithSerializerProvider
{
     ...
     * being visited
     */
    public void keyFormat(com.townmc.utils.jackson.databind.jsonFormatVisitors.JsonFormatVisitable handler, JavaType keyType) throws JsonMappingException;

    /**
     * Visit method called after {@link #keyFormat} to allow visiting of
     * the value type
     */
    public void valueFormat(com.townmc.utils.jackson.databind.jsonFormatVisitors.JsonFormatVisitable handler, JavaType valueType) throws JsonMappingException;

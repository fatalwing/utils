...
import com.townmc.utils.jackson.annotation.ObjectIdGenerator;
import com.townmc.utils.jackson.annotation.ObjectIdResolver;
...
import com.townmc.utils.jackson.databind.DatabindContext;
import com.townmc.utils.jackson.databind.DeserializationConfig;
import com.townmc.utils.jackson.databind.DeserializationFeature;
import com.townmc.utils.jackson.databind.InjectableValues;
...
import com.townmc.utils.jackson.databind.KeyDeserializer;
import com.townmc.utils.jackson.databind.MapperFeature;
import com.townmc.utils.jackson.databind.ObjectMapper;
import com.townmc.utils.jackson.databind.ObjectReader;
import com.townmc.utils.jackson.databind.cfg.ContextAttributes;
import com.townmc.utils.jackson.databind.deser.*;
import com.townmc.utils.jackson.databind.deser.impl.ObjectIdReader;
import com.townmc.utils.jackson.databind.deser.impl.ReadableObjectId;
import com.townmc.utils.jackson.databind.deser.impl.TypeWrappedDeserializer;
import com.townmc.utils.jackson.databind.exc.MismatchedInputException;
import com.townmc.utils.jackson.databind.exc.InvalidDefinitionException;
import com.townmc.utils.jackson.databind.exc.InvalidFormatException;
import com.townmc.utils.jackson.databind.exc.InvalidTypeIdException;
import com.townmc.utils.jackson.databind.exc.UnrecognizedPropertyException;
import com.townmc.utils.jackson.databind.introspect.Annotated;
import com.townmc.utils.jackson.databind.introspect.BeanPropertyDefinition;
...
import com.townmc.utils.jackson.databind.util.*;
 ...
 * is registered with {@link com.townmc.utils.jackson.databind.ObjectMapper} (and {@link ObjectReader},
    ...
    implements java.io.Serializable
{
    ...
    /**
     * Object that handle details of {@link com.townmc.utils.jackson.databind.JsonDeserializer} caching.
     */
     ...
     */
    protected final com.townmc.utils.jackson.databind.DeserializationConfig _config;
     ...
     * values.
     */
    protected final com.townmc.utils.jackson.databind.InjectableValues _injectableValues;
    ...
    /**
     * Type of {@link com.townmc.utils.jackson.databind.JsonDeserializer} (or, more specifically,
     *   {@link ContextualDeserializer}) that is being
     *   contextualized currently.
     *
     * @since 2.5
     */
    protected LinkedNode<com.townmc.utils.jackson.databind.JavaType> _currentType;
     ...
     */
    protected DeserializationContext(DeserializationContext src,
                                     com.townmc.utils.jackson.databind.DeserializationConfig config, JsonParser p,
    ...
    @Override
    public com.townmc.utils.jackson.databind.DeserializationConfig getConfig() { return _config; }
    ...
    @Override
    public final boolean isEnabled(com.townmc.utils.jackson.databind.MapperFeature feature) {
    ...
    /**
     * Accessor to {@link com.townmc.utils.jackson.databind.JavaType} of currently contextualized
     * {@link ContextualDeserializer}, if any.
     * This is sometimes useful for generic {@link com.townmc.utils.jackson.databind.JsonDeserializer}s that
     ...
     */
    public com.townmc.utils.jackson.databind.JavaType getContextualType() {
    ...
    public final Object findInjectableValue(Object valueId,
                                            com.townmc.utils.jackson.databind.BeanProperty forProperty, Object beanInstance)
        throws com.townmc.utils.jackson.databind.JsonMappingException
    {
...
"No 'injectableValues' configured, cannot inject value with id [%s]", valueId));
     ...
     * @since 2.3
     */
    public boolean hasValueDeserializerFor(com.townmc.utils.jackson.databind.JavaType type, AtomicReference<Throwable> cause) {
        try {
            return _cache.hasValueDeserializerFor(this, _factory, type);
        } catch (com.townmc.utils.jackson.databind.JsonMappingException e) {
            if (cause != null) {
                cause.set(e);
            }
    ...
    public final com.townmc.utils.jackson.databind.JsonDeserializer<Object> findContextualValueDeserializer(com.townmc.utils.jackson.databind.JavaType type,
                                                                                                         com.townmc.utils.jackson.databind.BeanProperty prop) throws com.townmc.utils.jackson.databind.JsonMappingException
    {
        com.townmc.utils.jackson.databind.JsonDeserializer<Object> deser = _cache.findValueDeserializer(this, _factory, type);
        if (deser != null) {
            deser = (com.townmc.utils.jackson.databind.JsonDeserializer<Object>) handleSecondaryContextualization(deser, prop, type);
        }
        return deser;
    }
     ...
     * {@link #findRootValueDeserializer(com.townmc.utils.jackson.databind.JavaType)}.
     * This method is usually called from within {@link ResolvableDeserializer#resolve},
     * and expectation is that caller then calls either
     * {@link #handlePrimaryContextualization(com.townmc.utils.jackson.databind.JsonDeserializer, com.townmc.utils.jackson.databind.BeanProperty, com.townmc.utils.jackson.databind.JavaType)} or
     * {@link #handleSecondaryContextualization(com.townmc.utils.jackson.databind.JsonDeserializer, com.townmc.utils.jackson.databind.BeanProperty, com.townmc.utils.jackson.databind.JavaType)} at a
     * later point, as necessary.
     *
     * @since 2.5
     */
    public final com.townmc.utils.jackson.databind.JsonDeserializer<Object> findNonContextualValueDeserializer(com.townmc.utils.jackson.databind.JavaType type)
        throws com.townmc.utils.jackson.databind.JsonMappingException
    {
     ...
     */
    @SuppressWarnings("unchecked")
    public final com.townmc.utils.jackson.databind.JsonDeserializer<Object> findRootValueDeserializer(com.townmc.utils.jackson.databind.JavaType type)
        throws com.townmc.utils.jackson.databind.JsonMappingException
    {
        com.townmc.utils.jackson.databind.JsonDeserializer<Object> deser = _cache.findValueDeserializer(this,
                _factory, type);
        if (deser == null) { // can this occur?
            return null;
        }
        deser = (com.townmc.utils.jackson.databind.JsonDeserializer<Object>) handleSecondaryContextualization(deser, null, type);
     ...
     *</pre>
     */
    public final com.townmc.utils.jackson.databind.KeyDeserializer findKeyDeserializer(com.townmc.utils.jackson.databind.JavaType keyType,
                                                                                    com.townmc.utils.jackson.databind.BeanProperty prop) throws com.townmc.utils.jackson.databind.JsonMappingException {
        com.townmc.utils.jackson.databind.KeyDeserializer kd = _cache.findKeyDeserializer(this,
                _factory, keyType);
     ...
     * </pre>
     */
    public final com.townmc.utils.jackson.databind.JavaType constructType(Class<?> cls) {
    ...
    public abstract com.townmc.utils.jackson.databind.JsonDeserializer<Object> deserializerInstance(Annotated annotated,
                                                                                                 Object deserDef)
        throws com.townmc.utils.jackson.databind.JsonMappingException;
     ...
     * @since 2.5
     */
    public com.townmc.utils.jackson.databind.JsonDeserializer<?> handlePrimaryContextualization(com.townmc.utils.jackson.databind.JsonDeserializer<?> deser,
                                                                                             com.townmc.utils.jackson.databind.BeanProperty prop, com.townmc.utils.jackson.databind.JavaType type)
        throws com.townmc.utils.jackson.databind.JsonMappingException
    {
        if (deser instanceof ContextualDeserializer) {
            _currentType = new LinkedNode<com.townmc.utils.jackson.databind.JavaType>(type, _currentType);
            try {
     ...
     * @since 2.5
     */
    public com.townmc.utils.jackson.databind.JsonDeserializer<?> handleSecondaryContextualization(com.townmc.utils.jackson.databind.JsonDeserializer<?> deser,
                                                                                               com.townmc.utils.jackson.databind.BeanProperty prop, com.townmc.utils.jackson.databind.JavaType type)
        throws com.townmc.utils.jackson.databind.JsonMappingException
    {
        if (deser instanceof ContextualDeserializer) {
     ...
     * rather use {@link #readPropertyValue(JsonParser, com.townmc.utils.jackson.databind.BeanProperty, Class)};
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T readValue(JsonParser p, com.townmc.utils.jackson.databind.JavaType type) throws IOException {
        com.townmc.utils.jackson.databind.JsonDeserializer<Object> deser = findRootValueDeserializer(type);
        if (deser == null) {
     ...
     * @since 2.4
     */
    public <T> T readPropertyValue(JsonParser p, com.townmc.utils.jackson.databind.BeanProperty prop, Class<T> type) throws IOException {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T readPropertyValue(JsonParser p, com.townmc.utils.jackson.databind.BeanProperty prop, com.townmc.utils.jackson.databind.JavaType type) throws IOException {
        com.townmc.utils.jackson.databind.JsonDeserializer<Object> deser = findContextualValueDeserializer(type, prop);
        if (deser == null) {
     ...
     *   problem
     */
    public boolean handleUnknownProperty(JsonParser p, com.townmc.utils.jackson.databind.JsonDeserializer<?> deser,
    ...
    public Object handleWeirdNativeValue(com.townmc.utils.jackson.databind.JavaType targetType, Object badValue,
                                         JsonParser p)
        throws IOException
    {
        LinkedNode<DeserializationProblemHandler> h = _config.getProblemHandlers();
        ...
        for (; h != null; h = h.next()) {
            ...
            if (goodValue != DeserializationProblemHandler.NOT_HANDLED) {
                ...
                throw com.townmc.utils.jackson.databind.JsonMappingException.from(p, _format(
...
"DeserializationProblemHandler.handleInstantiationProblem() for type %s returned value of type %s",
     ...
     *    if resolution fails.
     *
     * @return {@link com.townmc.utils.jackson.databind.JavaType} that id resolves to
     *
     ...
     * @since 2.8
     */
    public com.townmc.utils.jackson.databind.JavaType handleUnknownTypeId(com.townmc.utils.jackson.databind.JavaType baseType, String id,
                                                                       TypeIdResolver idResolver, String extraDesc) throws IOException
    {
        LinkedNode<DeserializationProblemHandler> h = _config.getProblemHandlers();
        while (h != null) {
            // Can bail out if it's handled
            com.townmc.utils.jackson.databind.JavaType type = h.value().handleUnknownTypeId(this, baseType, id, idResolver, extraDesc);
            if (type != null) {
     ...
     * @since 2.9
     */
    public com.townmc.utils.jackson.databind.JavaType handleMissingTypeId(com.townmc.utils.jackson.databind.JavaType baseType,
                                                                       TypeIdResolver idResolver, String extraDesc) throws IOException
    {
        LinkedNode<DeserializationProblemHandler> h = _config.getProblemHandlers();
        while (h != null) {
            // Can bail out if it's handled
            com.townmc.utils.jackson.databind.JavaType type = h.value().handleMissingTypeId(this, baseType, idResolver, extraDesc);
            if (type != null) {
                if (type.hasRawClass(Void.class)) {
                    return null;
                }
...
//        }
     ...
     * Note that this method will throw a {@link com.townmc.utils.jackson.databind.JsonMappingException} and no
     ...
     * @since 2.9
     */
    public void reportWrongTokenException(com.townmc.utils.jackson.databind.JsonDeserializer<?> deser,
     ...
     * @since 2.9
     */
    public void reportWrongTokenException(com.townmc.utils.jackson.databind.JavaType targetType,
                                          JsonToken expToken, String msg, Object... msgArgs)
        throws com.townmc.utils.jackson.databind.JsonMappingException
    {
        msg = _format(msg, msgArgs);
    ...
    public <T> T reportInputMismatch(BeanProperty prop,
            String msg, Object... msgArgs) throws com.townmc.utils.jackson.databind.JsonMappingException
    {
        msg = _format(msg, msgArgs);
        com.townmc.utils.jackson.databind.JavaType type = (prop == null) ? null : prop.getType();
     ...
     * @since 2.9
     */
    public <T> T reportInputMismatch(com.townmc.utils.jackson.databind.JsonDeserializer<?> src,
                                     String msg, Object... msgArgs) throws com.townmc.utils.jackson.databind.JsonMappingException
    {
        msg = _format(msg, msgArgs);
     ...
     * @since 2.9
     */
    public <T> T reportInputMismatch(com.townmc.utils.jackson.databind.JavaType targetType,
                                     String msg, Object... msgArgs) throws com.townmc.utils.jackson.databind.JsonMappingException
    {
        msg = _format(msg, msgArgs);
        throw MismatchedInputException.from(getParser(), targetType, msg);
    ...
    public <T> T reportTrailingTokens(Class<?> targetType,
            JsonParser p, JsonToken trailingToken) throws com.townmc.utils.jackson.databind.JsonMappingException
    {
...
trailingToken, ClassUtil.nameOf(targetType)
    ...
    public void reportUnknownProperty(Object instanceOrClass, String fieldName,
            com.townmc.utils.jackson.databind.JsonDeserializer<?> deser)
        throws com.townmc.utils.jackson.databind.JsonMappingException
    {
        if (isEnabled(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES)) {
            // Do we know properties that are expected instead?
     ...
     */
    @Deprecated // since 2.9
    public void reportMissingContent(String msg, Object... msgArgs) throws com.townmc.utils.jackson.databind.JsonMappingException {
        throw MismatchedInputException.from(getParser(), (com.townmc.utils.jackson.databind.JavaType) null, "No content to map due to end-of-input");
    }
     ...
     * Default behavior is to construct and throw a {@link com.townmc.utils.jackson.databind.JsonMappingException}.
     *
     * @since 2.9
     */
    public <T> T reportBadTypeDefinition(com.townmc.utils.jackson.databind.BeanDescription bean,
                                         String msg, Object... msgArgs) throws com.townmc.utils.jackson.databind.JsonMappingException {
        msg = _format(msg, msgArgs);
    ...
    @Override
    public <T> T reportBadDefinition(com.townmc.utils.jackson.databind.JavaType type, String msg) throws com.townmc.utils.jackson.databind.JsonMappingException {
     ...
     * Note that if {@link com.townmc.utils.jackson.databind.MapperFeature#IGNORE_MERGE_FOR_UNMERGEABLE} is enabled,
     * this method will simply return null; otherwise {@link InvalidDefinitionException}
     * will be thrown.
     *
     * @since 2.9
     */
    public <T> T reportBadMerge(JsonDeserializer<?> deser) throws com.townmc.utils.jackson.databind.JsonMappingException
    {
        if (isEnabled(MapperFeature.IGNORE_MERGE_FOR_UNMERGEABLE)) {
            return null;
        }
        com.townmc.utils.jackson.databind.JavaType type = constructType(deser.handledType());
    ...
    /**
     * Helper method for constructing {@link com.townmc.utils.jackson.databind.JsonMappingException} to indicate
     ...
     * @since 2.9
     */
    public com.townmc.utils.jackson.databind.JsonMappingException wrongTokenException(JsonParser p, com.townmc.utils.jackson.databind.JavaType targetType,
    ...
    public com.townmc.utils.jackson.databind.JsonMappingException wrongTokenException(JsonParser p, Class<?> targetType,
                                                                                   JsonToken expToken, String extra)
    {
        String msg = String.format("Unexpected token (%s), expected %s",
                p.getCurrentToken(), expToken);
    ...
    @Deprecated // since 2.9
    public com.townmc.utils.jackson.databind.JsonMappingException wrongTokenException(JsonParser p, JsonToken expToken,
                                                                                   String msg)
    {
        return wrongTokenException(p, (com.townmc.utils.jackson.databind.JavaType) null, expToken, msg);
    }
     ...
     * if necessary.
     */
    public com.townmc.utils.jackson.databind.JsonMappingException weirdKeyException(Class<?> keyClass, String keyValue,
                                                                                 String msg) {
     ...
     * @since 2.1
     */
    public com.townmc.utils.jackson.databind.JsonMappingException weirdStringException(String value, Class<?> instClass,
                                                                                    String msg) {
        return InvalidFormatException.from(_parser,
     ...
     * if necessary.
     */
    public com.townmc.utils.jackson.databind.JsonMappingException weirdNumberException(Number value, Class<?> instClass,
                                                                                    String msg) {
        return InvalidFormatException.from(_parser,
     ...
     * @since 2.9
     */
    public com.townmc.utils.jackson.databind.JsonMappingException weirdNativeValueException(Object value, Class<?> instClass)
    {
...
"Cannot deserialize value of type %s from native value (`JsonToken.VALUE_EMBEDDED_OBJECT`) of type %s: incompatible types",
     ...
     * if necessary.
     */
    public com.townmc.utils.jackson.databind.JsonMappingException instantiationException(Class<?> instClass, Throwable cause) {
        // Most likely problem with Creator definition, right?
        com.townmc.utils.jackson.databind.JavaType type = constructType(instClass);
     ...
     * if necessary.
     */
    public com.townmc.utils.jackson.databind.JsonMappingException instantiationException(Class<?> instClass, String msg0) {
        // Most likely problem with Creator definition, right?
        com.townmc.utils.jackson.databind.JavaType type = constructType(instClass);
    ...
    @Override
    public com.townmc.utils.jackson.databind.JsonMappingException invalidTypeIdException(com.townmc.utils.jackson.databind.JavaType baseType, String typeId,
                                                                                      String extraDesc) {
     ...
     * @since 2.9
     */
    public com.townmc.utils.jackson.databind.JsonMappingException missingTypeIdException(com.townmc.utils.jackson.databind.JavaType baseType,
                                                                                      String extraDesc) {
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.databind.JsonMappingException unknownTypeException(com.townmc.utils.jackson.databind.JavaType type, String id,
                                                                                    String extraDesc)
    {
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.databind.JsonMappingException endOfInputException(Class<?> instClass) {
    ...
    public void reportMappingException(String msg, Object... msgArgs)
        throws com.townmc.utils.jackson.databind.JsonMappingException
    {
        throw com.townmc.utils.jackson.databind.JsonMappingException.from(getParser(), _format(msg, msgArgs));
    }
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.databind.JsonMappingException mappingException(String message) {
        return com.townmc.utils.jackson.databind.JsonMappingException.from(getParser(), message);
    }
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.databind.JsonMappingException mappingException(String msg, Object... msgArgs) {
        return com.townmc.utils.jackson.databind.JsonMappingException.from(getParser(), _format(msg, msgArgs));
    }
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.databind.JsonMappingException mappingException(Class<?> targetClass) {
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.databind.JsonMappingException mappingException(Class<?> targetClass, JsonToken token) {

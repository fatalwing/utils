...
import com.townmc.utils.jackson.databind.cfg.HandlerInstantiator;
...
import com.townmc.utils.jackson.databind.introspect.AnnotatedConstructor;
...
import com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder;
import com.townmc.utils.jackson.databind.introspect.VisibilityChecker;
import com.townmc.utils.jackson.databind.util.BeanUtil;
...
public class POJOPropertiesCollector
{
     ...
     */
    protected final com.townmc.utils.jackson.databind.introspect.AnnotatedClass _classDef;
     ...
     */
    protected LinkedHashMap<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> _properties;

    protected LinkedList<com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> _creatorProperties;
    
    protected LinkedList<com.townmc.utils.jackson.databind.introspect.AnnotatedMember> _anyGetters;

    protected LinkedList<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod> _anySetters;
    
    protected LinkedList<com.townmc.utils.jackson.databind.introspect.AnnotatedMember> _anySetterField;
     ...
     */
    protected LinkedList<com.townmc.utils.jackson.databind.introspect.AnnotatedMember> _jsonValueAccessors;
     ...
     * value injection.
     */
    protected LinkedHashMap<Object, com.townmc.utils.jackson.databind.introspect.AnnotatedMember> _injectables;
    ...
    protected POJOPropertiesCollector(MapperConfig<?> config, boolean forSerialization,
                                      JavaType type, com.townmc.utils.jackson.databind.introspect.AnnotatedClass classDef, String mutatorPrefix)
    {
        _config = config;
    ...
    public List<com.townmc.utils.jackson.databind.introspect.BeanPropertyDefinition> getProperties() {
        // make sure we return a copy, so caller can remove entries if need be:
        Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props = getPropertyMap();
        return new ArrayList<BeanPropertyDefinition>(props.values());
    }

    public Map<Object, com.townmc.utils.jackson.databind.introspect.AnnotatedMember> getInjectables() {
        if (!_collected) {
            collectAll();
        }
        return _injectables;
    ...
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMethod getJsonValueMethod() {
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember m = getJsonValueAccessor();
        if (m instanceof com.townmc.utils.jackson.databind.introspect.AnnotatedMethod) {
            return (com.townmc.utils.jackson.databind.introspect.AnnotatedMethod) m;
        }
        return null;
    }
     ...
     * @since 2.9
     */
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMember getJsonValueAccessor()
    {
        if (!_collected) {
            collectAll();
        }
    ...
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMember getAnyGetter()
    {
        if (!_collected) {
            collectAll();
        }
    ...
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMember getAnySetterField()
    {
        if (!_collected) {
            collectAll();
        }
    ...
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMethod getAnySetterMethod()
    {
        if (!_collected) {
            collectAll();
        }
     ...
     */
    public com.townmc.utils.jackson.databind.introspect.ObjectIdInfo getObjectIdInfo()
    {
    ...
    // for unit tests:
    protected Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> getPropertyMap() {
        if (!_collected) {
            collectAll();
        }
        return _properties;
    ...
    {
        LinkedHashMap<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props = new LinkedHashMap<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder>();
        ...
        for (com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder property : props.values()) {
     ...
     */
    protected void _addFields(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props)
    {
        ...
        for (com.townmc.utils.jackson.databind.introspect.AnnotatedField f : _classDef.fields()) {
            ...
            if (Boolean.TRUE.equals(ai.hasAnySetter(f))) {
                if (_anySetterField == null) {
                    _anySetterField = new LinkedList<com.townmc.utils.jackson.databind.introspect.AnnotatedMember>();
                }
     ...
     */
    protected void _addCreators(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props)
    {
        ...
        for (AnnotatedConstructor ctor : _classDef.getConstructors()) {
            if (_creatorProperties == null) {
                _creatorProperties = new LinkedList<com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder>();
            }
            for (int i = 0, len = ctor.getParameterCount(); i < len; ++i) {
                _addCreatorParam(props, ctor.getParameter(i));
            }
        }
        for (com.townmc.utils.jackson.databind.introspect.AnnotatedMethod factory : _classDef.getFactoryMethods()) {
            if (_creatorProperties == null) {
                _creatorProperties = new LinkedList<com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder>();
            }
     ...
     * @since 2.4
     */
    protected void _addCreatorParam(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props,
            AnnotatedParameter param)
    {
         ...
         */
        com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder prop = (expl && impl.isEmpty())
     ...
     * Method for collecting basic information on all fields found
     */
    protected void _addMethods(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props)
    {
        final AnnotationIntrospector ai = _annotationIntrospector;
        for (com.townmc.utils.jackson.databind.introspect.AnnotatedMethod m : _classDef.memberMethods()) {
            ...
            if (argCount == 0) { // getters (including 'any getter')
                ...
                if (ai != null) {
                    if (Boolean.TRUE.equals(ai.hasAnySetter(m))) {
                        if (_anySetters == null) {
                            _anySetters = new LinkedList<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod>();
                        }
                        _anySetters.add(m);
                    }
                }
    ...
    protected void _addGetterMethod(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props,
                                    com.townmc.utils.jackson.databind.introspect.AnnotatedMethod m, AnnotationIntrospector ai)
    {
        ...
        if (Boolean.TRUE.equals(ai.hasAnyGetter(m))) {
            if (_anyGetters == null) {
                _anyGetters = new LinkedList<com.townmc.utils.jackson.databind.introspect.AnnotatedMember>();
            }
            _anyGetters.add(m);
            return;
        }
    ...
    protected void _addSetterMethod(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props,
                                    com.townmc.utils.jackson.databind.introspect.AnnotatedMethod m, AnnotationIntrospector ai)
    {
        String implName; // from naming convention
        boolean visible;
    ...
    protected void _addInjectables(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props)
    {
        final AnnotationIntrospector ai = _annotationIntrospector;
    ...
    protected void _doAddInjectable(JacksonInject.Value injectable, com.townmc.utils.jackson.databind.introspect.AnnotatedMember m)
    {
        if (injectable == null) {
            return;
        }
        ...
        if (_injectables == null) {
            _injectables = new LinkedHashMap<Object, com.townmc.utils.jackson.databind.introspect.AnnotatedMember>();
        }
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember prev = _injectables.put(id, m);
        if (prev != null) {
     ...
     * as ignored.
     */
    protected void _removeUnwantedProperties(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props)
    {
        Iterator<com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> it = props.values().iterator();
        while (it.hasNext()) {
            com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder prop = it.next();
     ...
     * (or not).
     */
    protected void _removeUnwantedAccessor(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props)
    {
    ...
    protected void _renameProperties(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props)
    {
        // With renaming need to do in phases: first, find properties to rename
        Iterator<Map.Entry<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder>> it = props.entrySet().iterator();
        LinkedList<com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> renamed = null;
        while (it.hasNext()) {
            Map.Entry<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> entry = it.next();
            com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder prop = entry.getValue();
            ...
            if (renamed == null) {
                renamed = new LinkedList<com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder>();
            }
        ...
        if (renamed != null) {
            for (com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder prop : renamed) {
                String name = prop.getName();
                com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder old = props.get(name);
                if (old == null) {
                    props.put(name, prop);
                } else {
                    old.addAll(prop);
    ...
    protected void _renameUsing(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> propMap,
            PropertyNamingStrategy naming)
    {
        com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder[] props = propMap.values().toArray(new com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder[propMap.size()]);
        propMap.clear();
        for (com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder prop : props) {
             ...
             * something in there...
             */
            com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder old = propMap.get(simpleName);
            if (old == null) {
    ...
    protected void _renameWithWrappers(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props)
    {
     ...
     */
    protected void _sortProperties(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props)
    {
        ...
        int size = props.size();
        Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> all;
        // Need to (re)sort alphabetically?
        if (sort) {
            all = new TreeMap<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder>();
        } else {
            all = new LinkedHashMap<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder>(size+size);
        }

        for (com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder prop : props.values()) {
            all.put(prop.getName(), prop);
        }
        Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> ordered = new LinkedHashMap<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder>(size+size);
        // Ok: primarily by explicit order
        if (propertyOrder != null) {
            for (String name : propertyOrder) {
                com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder w = all.get(name);
        ...
        if (_creatorProperties != null) {
             ...
             */
            Collection<com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> cr;
            if (sort) {
                TreeMap<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> sorted =
                        new TreeMap<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder>();
                for (com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder prop : _creatorProperties) {
            ...
            for (com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder prop : cr) {
    ...
    protected com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder _property(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props,
                                                                                      PropertyName name) {
        String simpleName = name.getSimpleName();
        com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder prop = props.get(simpleName);
        if (prop == null) {
            prop = new com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder(_config, _annotationIntrospector,
    ...
    protected com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder _property(Map<String, com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder> props,
                                                                                      String implName)
    {
        com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder prop = props.get(implName);
        if (prop == null) {
            prop = new com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder(_config, _annotationIntrospector, _forSerialization,
    ...
    protected void _updateCreatorProperty(com.townmc.utils.jackson.databind.introspect.POJOPropertyBuilder prop, List<POJOPropertyBuilder> creatorProperties) {

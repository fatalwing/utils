...
public abstract class AnnotatedMember
    extends com.townmc.utils.jackson.databind.introspect.Annotated
    implements java.io.Serializable
{
    ...
    // no need to persist
    protected final transient com.townmc.utils.jackson.databind.introspect.AnnotationMap _annotations;

    protected AnnotatedMember(TypeResolutionContext ctxt, com.townmc.utils.jackson.databind.introspect.AnnotationMap annotations) {
        super();
        _typeContext = ctxt;
     ...
     */
    public abstract Annotated withAnnotations(com.townmc.utils.jackson.databind.introspect.AnnotationMap fallback);
     ...
     * {@link com.townmc.utils.jackson.databind.MapperFeature#CAN_OVERRIDE_ACCESS_MODIFIERS}

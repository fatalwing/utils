...
import com.townmc.utils.jackson.annotation.ObjectIdGenerators;
import com.townmc.utils.jackson.annotation.JsonTypeInfo.As;

import com.townmc.utils.jackson.databind.*;
import com.townmc.utils.jackson.databind.cfg.SerializerFactoryConfig;
...
import com.townmc.utils.jackson.databind.ser.BasicSerializerFactory;
...
import com.townmc.utils.jackson.databind.ser.BeanSerializerBuilder;
import com.townmc.utils.jackson.databind.ser.BeanSerializerModifier;
import com.townmc.utils.jackson.databind.ser.PropertyBuilder;
import com.townmc.utils.jackson.databind.ser.ResolvableSerializer;
import com.townmc.utils.jackson.databind.ser.SerializerFactory;
import com.townmc.utils.jackson.databind.ser.Serializers;
import com.townmc.utils.jackson.databind.ser.impl.FilteredBeanPropertyWriter;
import com.townmc.utils.jackson.databind.ser.impl.ObjectIdWriter;
import com.townmc.utils.jackson.databind.ser.impl.PropertyBasedObjectIdGenerator;
import com.townmc.utils.jackson.databind.ser.std.MapSerializer;
import com.townmc.utils.jackson.databind.ser.std.StdDelegatingSerializer;
 ...
 * regular {@link com.townmc.utils.jackson.databind.ser.SerializerFactory} interface but rather via
    ...
    implements java.io.Serializable // since 2.1
{
    ...
    @Override
    protected Iterable<com.townmc.utils.jackson.databind.ser.Serializers> customSerializers() {
...
//            throw new IllegalArgumentException("Cannot create bean serializer for Object.class");
        ...
        final SerializationConfig config = prov.getConfig();
        com.townmc.utils.jackson.databind.ser.BeanSerializerBuilder builder = constructBeanSerializerBuilder(beanDesc);
        builder.setConfig(config);

        // First: any detectable (auto-detect, annotations) properties to serialize?
        List<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> props = findBeanProperties(prov, beanDesc, builder);
        if (props == null) {
            props = new ArrayList<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter>();
        } else {
    ...
    protected ObjectIdWriter constructObjectIdHandler(SerializerProvider prov,
            BeanDescription beanDesc, List<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> props)
        throws JsonMappingException
    {
        ...
        if (implClass == ObjectIdGenerators.PropertyGenerator.class) { // most special one, needs extra work
            ...
            com.townmc.utils.jackson.databind.ser.BeanPropertyWriter idProp = null;
            ...
            for (int i = 0, len = props.size() ;; ++i) {
                ...
                com.townmc.utils.jackson.databind.ser.BeanPropertyWriter prop = props.get(i);
     ...
     */
    protected com.townmc.utils.jackson.databind.ser.BeanPropertyWriter constructFilteredBeanWriter(com.townmc.utils.jackson.databind.ser.BeanPropertyWriter writer,
                                                                                                Class<?>[] inViews)
    {
        return FilteredBeanPropertyWriter.constructViewBased(writer, inViews);
    }
    
    protected com.townmc.utils.jackson.databind.ser.PropertyBuilder constructPropertyBuilder(SerializationConfig config,
                                                                                          BeanDescription beanDesc)
    {
        return new com.townmc.utils.jackson.databind.ser.PropertyBuilder(config, beanDesc);
    }

    protected com.townmc.utils.jackson.databind.ser.BeanSerializerBuilder constructBeanSerializerBuilder(BeanDescription beanDesc) {
        return new com.townmc.utils.jackson.databind.ser.BeanSerializerBuilder(beanDesc);
    }
     ...
     */
    protected List<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> findBeanProperties(SerializerProvider prov,
                                                                                             BeanDescription beanDesc, com.townmc.utils.jackson.databind.ser.BeanSerializerBuilder builder)
        throws JsonMappingException
    {
        ...
        com.townmc.utils.jackson.databind.ser.PropertyBuilder pb = constructPropertyBuilder(config, beanDesc);
        
        ArrayList<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> result = new ArrayList<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter>(properties.size());
     ...
     */
    protected List<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> filterBeanProperties(SerializationConfig config,
                                                                                               BeanDescription beanDesc, List<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> props)
    {
        ...
        if (ignorals != null) {
            ...
            if (!ignored.isEmpty()) {
                Iterator<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> it = props.iterator();
                while (it.hasNext()) {
     ...
     */
    protected void processViews(SerializationConfig config, com.townmc.utils.jackson.databind.ser.BeanSerializerBuilder builder)
    {
        // whether non-annotated fields are included by default or not is configurable
        List<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> props = builder.getProperties();
        boolean includeByDefault = config.isEnabled(MapperFeature.DEFAULT_VIEW_INCLUSION);
        final int propCount = props.size();
        int viewsFound = 0;
        com.townmc.utils.jackson.databind.ser.BeanPropertyWriter[] filtered = new com.townmc.utils.jackson.databind.ser.BeanPropertyWriter[propCount];
        // Simple: view information is stored within individual writers, need to combine:
        for (int i = 0; i < propCount; ++i) {
            com.townmc.utils.jackson.databind.ser.BeanPropertyWriter bpw = props.get(i);
     ...
     * by default this is based on {@link com.townmc.utils.jackson.annotation.JsonIgnoreType}
     ...
     * @since 2.6
     */
    protected List<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> removeOverlappingTypeIds(SerializerProvider prov,
                                                                                                   BeanDescription beanDesc, BeanSerializerBuilder builder,
                                                                                                   List<com.townmc.utils.jackson.databind.ser.BeanPropertyWriter> props)
    {
        for (int i = 0, end = props.size(); i < end; ++i) {
            ...
            for (com.townmc.utils.jackson.databind.ser.BeanPropertyWriter w2 : props) {
    ...
    /**
     * Secondary helper method for constructing {@link com.townmc.utils.jackson.databind.ser.BeanPropertyWriter} for
        ...
        throws JsonMappingException
    {
        ...
        if (annotatedSerializer instanceof com.townmc.utils.jackson.databind.ser.ResolvableSerializer) {

...
import com.townmc.utils.jackson.databind.jsonschema.SchemaAware;
    ...
    implements java.io.Serializable // since 2.1; only because ObjectWriter needs it
{
    ...
    protected DefaultSerializerProvider(SerializerProvider src,
                                        SerializationConfig config, com.townmc.utils.jackson.databind.ser.SerializerFactory f) {
        super(src, config, f);
    }
    ...
    public abstract DefaultSerializerProvider createInstance(SerializationConfig config,
            com.townmc.utils.jackson.databind.ser.SerializerFactory jsf);
...
filter.getClass().getName(), t.getClass().getName(), t.getMessage());
    ...
    public com.townmc.utils.jackson.databind.jsonschema.JsonSchema generateJsonSchema(Class<?> type)
        throws JsonMappingException
    {
        /* no need for embedded type information for JSON schema generation (all
         * type information it needs is accessible via "untyped" serializer)
        ...
        JsonNode schemaNode = (ser instanceof SchemaAware) ?
                ((SchemaAware) ser).getSchema(this, null) : com.townmc.utils.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
        if (!(schemaNode instanceof ObjectNode)) {
            throw new IllegalArgumentException("Class " + type.getName()
                    +" would not be serialized as a JSON object and therefore has no schema");
        }
        return new com.townmc.utils.jackson.databind.jsonschema.JsonSchema((ObjectNode) schemaNode);
    }
    ...
    public final static class Impl extends DefaultSerializerProvider {
        ...
        protected Impl(SerializerProvider src, SerializationConfig config,
                com.townmc.utils.jackson.databind.ser.SerializerFactory f) {
            super(src, config, f);
        }

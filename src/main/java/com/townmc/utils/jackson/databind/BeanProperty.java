...
import com.townmc.utils.jackson.annotation.JsonFormat.Value;
...
import com.townmc.utils.jackson.databind.util.Named;
 ...
 * is known when
 * {@link com.townmc.utils.jackson.databind.ser.ContextualSerializer} and
 * {@link com.townmc.utils.jackson.databind.deser.ContextualDeserializer}
...
public interface BeanProperty extends Named
{
     ...
     */
    public com.townmc.utils.jackson.databind.JavaType getType();
        ...
        java.io.Serializable // 2.9
    {
        ...
        protected final com.townmc.utils.jackson.databind.JavaType _type;
        ...
        public Std(PropertyName name, com.townmc.utils.jackson.databind.JavaType type, PropertyName wrapperName,
         ...
         * @since 2.6
         */
        public Std(Std base, com.townmc.utils.jackson.databind.JavaType newType) {
            this(base._name, newType, base._wrapperName, base._member, base._metadata);
        }

        public Std withType(com.townmc.utils.jackson.databind.JavaType type) {
        ...
        @Override public com.townmc.utils.jackson.databind.JavaType getType() { return _type; }

...
import com.townmc.utils.jackson.annotation.Nulls;
import com.townmc.utils.jackson.databind.*;
import com.townmc.utils.jackson.databind.cfg.ConfigOverride;
    ...
    implements Comparable<POJOPropertyBuilder>
{
    ...
    protected Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedField> _fields;

    protected Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedParameter> _ctorParameters;

    protected Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod> _getters;

    protected Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod> _setters;
    ...
    public PropertyName getWrapperName() {
         ...
         */
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember member = getPrimaryMember();
...
//                || _anyExplicits(_ctorParameters)
    ...
    protected PropertyMetadata _getSetterInfo(PropertyMetadata metadata)
    {
        ...
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember prim = getPrimaryMember();
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember acc = getAccessor();
    ...
    public JavaType getPrimaryType() {
        if (_forSerialization) {
            com.townmc.utils.jackson.databind.introspect.AnnotatedMember m = getGetter();
            if (m == null) {
                m = getField();
                if (m == null) {
        ...
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember m = getConstructorParameter();
        if (m == null) {
            m = getSetter();
            // Important: can't try direct type access for setter; what we need is
            // type of the first parameter
            if (m != null) {
                return ((com.townmc.utils.jackson.databind.introspect.AnnotatedMethod) m).getParameterType(0);
            }
            m = getField();
        }
    ...
    @Override
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMethod getGetter()
    {
        // Easy with zero or one getters...
        Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod> curr = _getters;
        if (curr == null) {
            return null;
        }
        Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod> next = curr.next;
        if (next == null) {
            return curr.value;
        }
    ...
    @Override
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMethod getSetter()
    {
        // Easy with zero or one getters...
        Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod> curr = _setters;
        if (curr == null) {
            return null;
        }
        Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod> next = curr.next;
        ...
        for (; next != null; next = next.next) {
            ...
            com.townmc.utils.jackson.databind.introspect.AnnotatedMethod nextM = next.value;
            com.townmc.utils.jackson.databind.introspect.AnnotatedMethod currM = curr.value;
            ...
            if (_annotationIntrospector != null) {
                com.townmc.utils.jackson.databind.introspect.AnnotatedMethod pref = _annotationIntrospector.resolveSetterConflict(_config,
                        currM, nextM);
 ...
 getName(), curr.value.getFullName(), next.value.getFullName()));
    ...
    @Override
    public com.townmc.utils.jackson.databind.introspect.AnnotatedField getField()
    {
        if (_fields == null) {
            return null;
        }
        // If multiple, verify that they do not conflict...
        com.townmc.utils.jackson.databind.introspect.AnnotatedField field = _fields.value;
        Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedField> next = _fields.next;
        for (; next != null; next = next.next) {
            com.townmc.utils.jackson.databind.introspect.AnnotatedField nextField = next.value;
    ...
    @Override
    public com.townmc.utils.jackson.databind.introspect.AnnotatedParameter getConstructorParameter()
    {
        if (_ctorParameters == null) {
            return null;
        }
         ...
         */
        Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedParameter> curr = _ctorParameters;
        do {
    ...
    @Override
    public Iterator<com.townmc.utils.jackson.databind.introspect.AnnotatedParameter> getConstructorParameters() {
        if (_ctorParameters == null) {
            return ClassUtil.emptyIterator();
        }
        return new MemberIterator<com.townmc.utils.jackson.databind.introspect.AnnotatedParameter>(_ctorParameters);
    }

    @Override
    public com.townmc.utils.jackson.databind.introspect.AnnotatedMember getPrimaryMember() {
        if (_forSerialization) {
            return getAccessor();
        }
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember m = getMutator();
    ...
    protected int _getterPriority(com.townmc.utils.jackson.databind.introspect.AnnotatedMethod m)
    {
    ...
    protected int _setterPriority(com.townmc.utils.jackson.databind.introspect.AnnotatedMethod m)
    {
        final String name = m.getName();
    ...
    public Class<?>[] findViews() {
        return fromMemberAnnotations(new WithMember<Class<?>[]>() {
            @Override
            public Class<?>[] withMember(com.townmc.utils.jackson.databind.introspect.AnnotatedMember member) {
    ...
    public AnnotationIntrospector.ReferenceProperty findReferenceType() {
        ...
        result = fromMemberAnnotations(new WithMember<AnnotationIntrospector.ReferenceProperty>() {
            @Override
            public AnnotationIntrospector.ReferenceProperty withMember(com.townmc.utils.jackson.databind.introspect.AnnotatedMember member) {
    ...
    public boolean isTypeId() {
        Boolean b = fromMemberAnnotations(new WithMember<Boolean>() {
            @Override
            public Boolean withMember(com.townmc.utils.jackson.databind.introspect.AnnotatedMember member) {
    ...
    protected String _findDescription() {
        return fromMemberAnnotations(new WithMember<String>() {
            @Override
            public String withMember(com.townmc.utils.jackson.databind.introspect.AnnotatedMember member) {
    ...
    protected Integer _findIndex() {
        return fromMemberAnnotations(new WithMember<Integer>() {
            @Override
            public Integer withMember(com.townmc.utils.jackson.databind.introspect.AnnotatedMember member) {
    ...
    @Override
    public com.townmc.utils.jackson.databind.introspect.ObjectIdInfo findObjectIdInfo() {
        return fromMemberAnnotations(new WithMember<com.townmc.utils.jackson.databind.introspect.ObjectIdInfo>() {
            @Override
            public com.townmc.utils.jackson.databind.introspect.ObjectIdInfo withMember(com.townmc.utils.jackson.databind.introspect.AnnotatedMember member) {
    ...
    public JsonInclude.Value findInclusion() {
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember a = getAccessor();
    ...
    public JsonProperty.Access findAccess() {
        return fromMemberAnnotationsExcept(new WithMember<JsonProperty.Access>() {
            @Override
            public JsonProperty.Access withMember(com.townmc.utils.jackson.databind.introspect.AnnotatedMember member) {
    ...
    public void addField(com.townmc.utils.jackson.databind.introspect.AnnotatedField a, PropertyName name, boolean explName, boolean visible, boolean ignored) {
        _fields = new Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedField>(a, _fields, name, explName, visible, ignored);
    }

    public void addCtor(com.townmc.utils.jackson.databind.introspect.AnnotatedParameter a, PropertyName name, boolean explName, boolean visible, boolean ignored) {
        _ctorParameters = new Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedParameter>(a, _ctorParameters, name, explName, visible, ignored);
    }

    public void addGetter(com.townmc.utils.jackson.databind.introspect.AnnotatedMethod a, PropertyName name, boolean explName, boolean visible, boolean ignored) {
        _getters = new Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod>(a, _getters, name, explName, visible, ignored);
    }

    public void addSetter(com.townmc.utils.jackson.databind.introspect.AnnotatedMethod a, PropertyName name, boolean explName, boolean visible, boolean ignored) {
        _setters = new Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod>(a, _setters, name, explName, visible, ignored);
    }
    ...
    public void mergeAnnotations(boolean forSerialization)
    {
        if (forSerialization) {
            if (_getters != null) {
                com.townmc.utils.jackson.databind.introspect.AnnotationMap ann = _mergeAnnotations(0, _getters, _fields, _ctorParameters, _setters);
                _getters = _applyAnnotations(_getters, ann);
            } else if (_fields != null) {
                com.townmc.utils.jackson.databind.introspect.AnnotationMap ann = _mergeAnnotations(0, _fields, _ctorParameters, _setters);
                _fields = _applyAnnotations(_fields, ann);
            }
        } else { // for deserialization
            if (_ctorParameters != null) {
                com.townmc.utils.jackson.databind.introspect.AnnotationMap ann = _mergeAnnotations(0, _ctorParameters, _setters, _fields, _getters);
                _ctorParameters = _applyAnnotations(_ctorParameters, ann);
            } else if (_setters != null) {
                com.townmc.utils.jackson.databind.introspect.AnnotationMap ann = _mergeAnnotations(0, _setters, _fields, _getters);
                _setters = _applyAnnotations(_setters, ann);
            } else if (_fields != null) {
                com.townmc.utils.jackson.databind.introspect.AnnotationMap ann = _mergeAnnotations(0, _fields, _getters);
                _fields = _applyAnnotations(_fields, ann);
            }
        }
    }

    private com.townmc.utils.jackson.databind.introspect.AnnotationMap _mergeAnnotations(int index,
                                                                                      Linked<? extends com.townmc.utils.jackson.databind.introspect.AnnotatedMember>... nodes)
    {
        com.townmc.utils.jackson.databind.introspect.AnnotationMap ann = _getAllAnnotations(nodes[index]);
        while (++index < nodes.length) {
            if (nodes[index] != null) {
                return com.townmc.utils.jackson.databind.introspect.AnnotationMap.merge(ann, _mergeAnnotations(index, nodes));
            }
        }
        return ann;
    }
     ...
     * @since 2.6
     */
    private <T extends com.townmc.utils.jackson.databind.introspect.AnnotatedMember> com.townmc.utils.jackson.databind.introspect.AnnotationMap _getAllAnnotations(Linked<T> node) {
        com.townmc.utils.jackson.databind.introspect.AnnotationMap ann = node.value.getAllAnnotations();
        if (node.next != null) {
            ann = com.townmc.utils.jackson.databind.introspect.AnnotationMap.merge(ann, _getAllAnnotations(node.next));
        }
        return ann;
    }
     ...
     * @since 2.6
     */
    private <T extends com.townmc.utils.jackson.databind.introspect.AnnotatedMember> Linked<T> _applyAnnotations(Linked<T> node, AnnotationMap ann) {
        @SuppressWarnings("unchecked")
            ...
            Linked<?> accessors)
    {
        ...
        for (Linked<?> node = accessors; node != null; node = node.next) {
            ...
            if (firstAcc == _fields) {
                Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedField> n2 = (Linked<AnnotatedField>) node;
                prop._fields = n2.withNext(prop._fields);
            } else if (firstAcc == _getters) {
                Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod> n2 = (Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod>) node;
                prop._getters = n2.withNext(prop._getters);
            } else if (firstAcc == _setters) {
                Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedMethod> n2 = (Linked<AnnotatedMethod>) node;
                prop._setters = n2.withNext(prop._setters);
            } else if (firstAcc == _ctorParameters) {
                Linked<com.townmc.utils.jackson.databind.introspect.AnnotatedParameter> n2 = (Linked<AnnotatedParameter>) node;
    ...
    private Set<PropertyName> _findExplicitNames(Linked<? extends com.townmc.utils.jackson.databind.introspect.AnnotatedMember> node,
    ...
    private interface WithMember<T> {
        public T withMember(com.townmc.utils.jackson.databind.introspect.AnnotatedMember member);
    }

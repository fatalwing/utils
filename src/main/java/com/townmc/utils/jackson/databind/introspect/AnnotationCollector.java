 ...
 * {@link Annotations} (like {@link com.townmc.utils.jackson.databind.introspect.AnnotationMap}).
 *
 * @since 2.9
 */
public abstract class AnnotationCollector
{
    ...
    public abstract com.townmc.utils.jackson.databind.introspect.AnnotationMap asAnnotationMap();
    ...
    static class EmptyCollector extends AnnotationCollector
    {
        ...
        @Override
        public com.townmc.utils.jackson.databind.introspect.AnnotationMap asAnnotationMap() {
    ...
    static class OneCollector extends AnnotationCollector
    {
        ...
        @Override
        public com.townmc.utils.jackson.databind.introspect.AnnotationMap asAnnotationMap() {
            return com.townmc.utils.jackson.databind.introspect.AnnotationMap.of(_type, _value);
        }
    ...
    static class NCollector extends AnnotationCollector
    {
        ...
        public Annotations asAnnotations() {
            ...
            return new com.townmc.utils.jackson.databind.introspect.AnnotationMap(_annotations);
        }

        @Override
        public com.townmc.utils.jackson.databind.introspect.AnnotationMap asAnnotationMap() {
            com.townmc.utils.jackson.databind.introspect.AnnotationMap result = new AnnotationMap();

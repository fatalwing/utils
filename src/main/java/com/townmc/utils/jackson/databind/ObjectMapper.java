...
import com.townmc.utils.jackson.annotation.*;
import com.townmc.utils.jackson.core.*;
import com.townmc.utils.jackson.core.io.CharacterEscapes;
import com.townmc.utils.jackson.core.io.SegmentedStringWriter;
import com.townmc.utils.jackson.core.type.ResolvedType;
import com.townmc.utils.jackson.core.type.TypeReference;
import com.townmc.utils.jackson.core.util.*;
...
import com.townmc.utils.jackson.databind.Module;
import com.townmc.utils.jackson.databind.cfg.*;
import com.townmc.utils.jackson.databind.deser.*;
import com.townmc.utils.jackson.databind.exc.MismatchedInputException;
import com.townmc.utils.jackson.databind.introspect.*;
import com.townmc.utils.jackson.databind.jsonFormatVisitors.JsonFormatVisitorWrapper;
import com.townmc.utils.jackson.databind.jsontype.*;
import com.townmc.utils.jackson.databind.jsontype.impl.StdSubtypeResolver;
import com.townmc.utils.jackson.databind.jsontype.impl.StdTypeResolverBuilder;
import com.townmc.utils.jackson.databind.node.*;
import com.townmc.utils.jackson.databind.ser.*;
import com.townmc.utils.jackson.databind.type.*;
import com.townmc.utils.jackson.databind.util.ClassUtil;
import com.townmc.utils.jackson.databind.util.RootNameLookup;
import com.townmc.utils.jackson.databind.util.StdDateFormat;
import com.townmc.utils.jackson.databind.util.TokenBuffer;

/**
 * ObjectMapper provides functionality for reading and writing JSON,
 * either to and from basic POJOs (Plain Old Java Objects), or to and from
 * a general-purpose JSON Tree Model ({@link com.townmc.utils.jackson.databind.JsonNode}), as well as
        ...
        Serializable // as of 2.1
{
        ...
        implements Serializable
    {
        ...
        public TypeDeserializer buildTypeDeserializer(DeserializationConfig config,
                                                      com.townmc.utils.jackson.databind.JavaType baseType, Collection<NamedType> subtypes)
        {
         ...
         */
        public boolean useForType(com.townmc.utils.jackson.databind.JavaType t)
        {
    ...
    private final static com.townmc.utils.jackson.databind.JavaType JSON_NODE_TYPE =
            SimpleType.constructUnsafe(com.townmc.utils.jackson.databind.JsonNode.class);
//            TypeFactory.defaultInstance().constructType(JsonNode.class);
    ...
    /**
     * Specific factory used for creating {@link com.townmc.utils.jackson.databind.JavaType} instances;
    ...
    /**
     * Set of module types (as per {@link com.townmc.utils.jackson.databind.Module#getTypeId()} that have been
     ...
     */
    final protected ConcurrentHashMap<com.townmc.utils.jackson.databind.JavaType, JsonDeserializer<Object>> _rootDeserializers
        = new ConcurrentHashMap<com.townmc.utils.jackson.databind.JavaType, JsonDeserializer<Object>>(64, 0.6f, 2);
     ...
     */
    protected ObjectReader _newReader(DeserializationConfig config,
                                      com.townmc.utils.jackson.databind.JavaType valueType, Object valueToUpdate,
     ...
     */
    protected ObjectWriter _newWriter(SerializationConfig config,
                                      com.townmc.utils.jackson.databind.JavaType rootType, PrettyPrinter pp) {
     ...
     */
    public ObjectMapper registerModule(com.townmc.utils.jackson.databind.Module module)
    {
        ...
        module.setupModule(new com.townmc.utils.jackson.databind.Module.SetupContext()
        {
            // // // Accessors
     ...
     * @since 2.2
     */
    public ObjectMapper registerModules(com.townmc.utils.jackson.databind.Module... modules)
    {
        for (com.townmc.utils.jackson.databind.Module module : modules) {
            registerModule(module);
        }
        return this;
    }
     ...
     * @since 2.2
     */
    public ObjectMapper registerModules(Iterable<com.townmc.utils.jackson.databind.Module> modules)
    {
        for (com.townmc.utils.jackson.databind.Module module : modules) {
            registerModule(module);
        }
     ...
     * @since 2.2
     */
    public static List<com.townmc.utils.jackson.databind.Module> findModules() {
     ...
     * @since 2.2
     */
    public static List<com.townmc.utils.jackson.databind.Module> findModules(ClassLoader classLoader)
    {
        ArrayList<com.townmc.utils.jackson.databind.Module> modules = new ArrayList<com.townmc.utils.jackson.databind.Module>();
        ServiceLoader<com.townmc.utils.jackson.databind.Module> loader = secureGetServiceLoader(com.townmc.utils.jackson.databind.Module.class, classLoader);
    ...
    */
    ...
    /**
     * Convenience method for constructing {@link com.townmc.utils.jackson.databind.JavaType} out of given
     * type (typically <code>java.lang.Class</code>), but without explicit
     * context.
     */
    public com.townmc.utils.jackson.databind.JavaType constructType(Type t) {
     ...
     * root {@link com.townmc.utils.jackson.databind.JsonNode} instances for Trees.
     *<p>
    ...
    public final <T> T readValue(JsonParser p, ResolvedType valueType)
        throws IOException, JsonParseException, JsonMappingException
    {
        return (T) _readValue(getDeserializationConfig(), p, (com.townmc.utils.jackson.databind.JavaType) valueType);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T readValue(JsonParser p, com.townmc.utils.jackson.databind.JavaType valueType)
        throws IOException, JsonParseException, JsonMappingException
    {
     ...
     * using set of {@link com.townmc.utils.jackson.databind.JsonNode} instances. Returns
     * root of the resulting tree (where root can consist
     * of just a single node if the current event is a
     * value event, not container).
     * 
     * @return a {@link com.townmc.utils.jackson.databind.JsonNode}, if valid JSON content found; null
     *   if input has no content to bind -- note, however, that if
     *   JSON <code>null</code> token is found, it will be represented
     *   as a non-null {@link com.townmc.utils.jackson.databind.JsonNode} (one that returns <code>true</code>
     *   for {@link com.townmc.utils.jackson.databind.JsonNode#isNull()}
     * 
     * @throws IOException if a low-level I/O problem (unexpected end-of-input,
     *   network error) occurs (passed through as-is without additional wrapping -- note
     *   that this is one case where {@link DeserializationFeature#WRAP_EXCEPTIONS}
        ...
        throws IOException, JsonProcessingException
    {
        ...
        com.townmc.utils.jackson.databind.JsonNode n = (com.townmc.utils.jackson.databind.JsonNode) _readValue(cfg, p, JSON_NODE_TYPE);
        if (n == null) {
    ...
    public <T> MappingIterator<T> readValues(JsonParser p, ResolvedType valueType)
        throws IOException, JsonProcessingException
    {
        return readValues(p, (com.townmc.utils.jackson.databind.JavaType) valueType);
    }
     ...
     */
    public <T> MappingIterator<T> readValues(JsonParser p, com.townmc.utils.jackson.databind.JavaType valueType)
        throws IOException, JsonProcessingException
    {
    ...
    /**
     * Method to deserialize JSON content as tree expressed
     * using set of {@link com.townmc.utils.jackson.databind.JsonNode} instances.
     ...
     *    of type {@link JsonParser} supports (JSON for default case)
     */
    public com.townmc.utils.jackson.databind.JsonNode readTree(InputStream in) throws IOException
    {
     ...
     *   for {@link com.townmc.utils.jackson.databind.JsonNode#isNull()}
     */
    public com.townmc.utils.jackson.databind.JsonNode readTree(Reader r) throws IOException {
        return _readTreeAndClose(_jsonFactory.createParser(r));
    }

    /**
     * Method to deserialize JSON content as tree expressed using set of {@link com.townmc.utils.jackson.databind.JsonNode} instances.
     ...
     *    of type {@link JsonParser} supports (JSON for default case)
     */
    public com.townmc.utils.jackson.databind.JsonNode readTree(String content) throws IOException {
     ...
     *    of type {@link JsonParser} supports (JSON for default case)
     */
    public com.townmc.utils.jackson.databind.JsonNode readTree(byte[] content) throws IOException {
        return _readTreeAndClose(_jsonFactory.createParser(content));
    }
     ...
     *    of type {@link JsonParser} supports (JSON for default case)
     */
    public com.townmc.utils.jackson.databind.JsonNode readTree(File file)
        throws IOException, JsonProcessingException
    {
     ...
     *    of type {@link JsonParser} supports (JSON for default case)
     */
    public com.townmc.utils.jackson.databind.JsonNode readTree(URL source) throws IOException {
     ...
     * provided.
     */
    public void writeTree(JsonGenerator jgen, com.townmc.utils.jackson.databind.JsonNode rootNode)
        throws IOException, JsonProcessingException
    {
        SerializationConfig config = getSerializationConfig();
        _serializerProvider(config).serializeValue(jgen, rootNode);
    ...
    public JsonParser treeAsTokens(TreeNode n) {
        return new TreeTraversingParser((com.townmc.utils.jackson.databind.JsonNode) n, this);
    }
     ...
     * raw value ({@link com.townmc.utils.jackson.databind.util.RawValue}) or basic
     * node identity ({@link com.townmc.utils.jackson.databind.JsonNode}). If so, result is a valid tree, but values
     ...
     * 
     * @param <T> Actual node type; usually either basic {@link com.townmc.utils.jackson.databind.JsonNode} or
     *  {@link ObjectNode}
     * @param fromValue Bean value to convert
     * @return Root node of the resulting JSON tree
     */
    @SuppressWarnings({ "unchecked", "resource" })
    public <T extends com.townmc.utils.jackson.databind.JsonNode> T valueToTree(Object fromValue)
        throws IllegalArgumentException
    {
        ...
        com.townmc.utils.jackson.databind.JsonNode result;
        try {
     ...
     * {@link #canDeserialize(com.townmc.utils.jackson.databind.JavaType, AtomicReference)} instead.
     *
     * @return True if mapper can find a serializer for instances of
     *  given class (potentially serializable), false otherwise (not
     *  serializable)
     */
    public boolean canDeserialize(com.townmc.utils.jackson.databind.JavaType type)
    {
    ...
    /**
     * Method similar to {@link #canDeserialize(com.townmc.utils.jackson.databind.JavaType)} but that can return
     * actual {@link Throwable} that was thrown when trying to construct
     * serializer: this may be useful in figuring out what the actual problem is.
     * 
     * @since 2.3
     */
    public boolean canDeserialize(com.townmc.utils.jackson.databind.JavaType type, AtomicReference<Throwable> cause)
    {
        return createDeserializationContext(null,
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T readValue(File src, com.townmc.utils.jackson.databind.JavaType valueType)
        throws IOException, JsonParseException, JsonMappingException
    {
    ...
    @SuppressWarnings("unchecked")
    public <T> T readValue(URL src, com.townmc.utils.jackson.databind.JavaType valueType)
        throws IOException, JsonParseException, JsonMappingException
    {
        return (T) _readMapAndClose(_jsonFactory.createParser(src), valueType);
    } 
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T readValue(String content, com.townmc.utils.jackson.databind.JavaType valueType)
        throws IOException, JsonParseException, JsonMappingException
    {
    ...
    @SuppressWarnings("unchecked")
    public <T> T readValue(Reader src, com.townmc.utils.jackson.databind.JavaType valueType)
        throws IOException, JsonParseException, JsonMappingException
    {
        return (T) _readMapAndClose(_jsonFactory.createParser(src), valueType);
    } 
    ...
    @SuppressWarnings("unchecked")
    public <T> T readValue(InputStream src, com.townmc.utils.jackson.databind.JavaType valueType)
        throws IOException, JsonParseException, JsonMappingException
    {
        return (T) _readMapAndClose(_jsonFactory.createParser(src), valueType);
    } 
    ...
    @SuppressWarnings("unchecked")
    public <T> T readValue(byte[] src, com.townmc.utils.jackson.databind.JavaType valueType)
        throws IOException, JsonParseException, JsonMappingException
    {
        return (T) _readMapAndClose(_jsonFactory.createParser(src), valueType);
    } 
    ...
    @SuppressWarnings("unchecked")
    public <T> T readValue(byte[] src, int offset, int len,
                           com.townmc.utils.jackson.databind.JavaType valueType)
        throws IOException, JsonParseException, JsonMappingException
    {
    ...
    @SuppressWarnings("unchecked")
    public <T> T readValue(DataInput src, com.townmc.utils.jackson.databind.JavaType valueType) throws IOException
    {
        return (T) _readMapAndClose(_jsonFactory.createParser(src), valueType);
    }
     ...
     * @since 2.5
     */
    public ObjectWriter writerFor(com.townmc.utils.jackson.databind.JavaType rootType) {
    ...
    /**
     * @deprecated Since 2.5, use {@link #writerFor(com.townmc.utils.jackson.databind.JavaType)} instead
     */
    @Deprecated
    public ObjectWriter writerWithType(com.townmc.utils.jackson.databind.JavaType rootType) {
        return _newWriter(getSerializationConfig(), rootType, /*PrettyPrinter*/null);
    }
    ...
    public ObjectReader readerForUpdating(Object valueToUpdate) {
        com.townmc.utils.jackson.databind.JavaType t = _typeFactory.constructType(valueToUpdate.getClass());
     ...
     * @since 2.6
     */
    public ObjectReader readerFor(com.townmc.utils.jackson.databind.JavaType type) {
    ...
    /**
     * @deprecated Since 2.5, use {@link #readerFor(com.townmc.utils.jackson.databind.JavaType)} instead
     */
    @Deprecated
    public ObjectReader reader(com.townmc.utils.jackson.databind.JavaType type) {
        return _newReader(getDeserializationConfig(), type, null,
                null, _injectableValues);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T convertValue(Object fromValue, com.townmc.utils.jackson.databind.JavaType toValueType)
        throws IllegalArgumentException
    {
     ...
     */
    @SuppressWarnings("resource")
    protected Object _convert(Object fromValue, com.townmc.utils.jackson.databind.JavaType toValueType)
        throws IllegalArgumentException
    {
    ...
    /**
     * Convenience method similar to {@link #convertValue(Object, com.townmc.utils.jackson.databind.JavaType)} but one
     * in which 
     *<p>
     ...
     *    (which under the hood calls {@link #acceptJsonFormatVisitor(com.townmc.utils.jackson.databind.JavaType, JsonFormatVisitorWrapper)})
     */
    @Deprecated
    public com.townmc.utils.jackson.databind.jsonschema.JsonSchema generateJsonSchema(Class<?> t)
            throws JsonMappingException {
     ...
     * @since 2.1
     */
    public void acceptJsonFormatVisitor(com.townmc.utils.jackson.databind.JavaType type, JsonFormatVisitorWrapper visitor)
        throws JsonMappingException
    {
        if (type == null) {
    ...
    protected Object _readMapAndClose(JsonParser p0, com.townmc.utils.jackson.databind.JavaType valueType)
        throws IOException
    {
        try (JsonParser p = p0) {
            Object result;
     ...
     * @since 2.9
     */
    protected com.townmc.utils.jackson.databind.JsonNode _readTreeAndClose(JsonParser p0) throws IOException
    {
        try (JsonParser p = p0) {
            final com.townmc.utils.jackson.databind.JavaType valueType = JSON_NODE_TYPE;
...
//            ctxt.checkUnresolvedObjectId();
    ...
    protected Object _unwrapAndDeserialize(JsonParser p, DeserializationContext ctxt,
                                           ...
                                           com.townmc.utils.jackson.databind.JavaType rootType, JsonDeserializer<Object> deser)
        throws IOException
    {
     ...
     *   enf-of-stream not)
     */
    protected JsonToken _initForReading(JsonParser p, com.townmc.utils.jackson.databind.JavaType targetType) throws IOException
    {
    ...
    protected final void _verifyNoTrailingTokens(JsonParser p, DeserializationContext ctxt,
            com.townmc.utils.jackson.databind.JavaType bindType)
        throws IOException
    {

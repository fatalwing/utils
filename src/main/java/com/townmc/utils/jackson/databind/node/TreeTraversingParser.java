...
import com.townmc.utils.jackson.core.base.ParserMinimalBase;

import com.townmc.utils.jackson.databind.JsonNode;
import com.townmc.utils.jackson.databind.node.BinaryNode;
import com.townmc.utils.jackson.databind.node.NodeCursor;
...
public class TreeTraversingParser extends ParserMinimalBase
{
     ...
     */
    protected com.townmc.utils.jackson.databind.node.NodeCursor _nodeCursor;
    ...
    public TreeTraversingParser(JsonNode n, ObjectCodec codec)
    {
        ...
        if (n.isArray()) {
            ...
            _nodeCursor = new com.townmc.utils.jackson.databind.node.NodeCursor.ArrayCursor(n, null);
        } else if (n.isObject()) {
            _nextToken = JsonToken.START_OBJECT;
            _nodeCursor = new com.townmc.utils.jackson.databind.node.NodeCursor.ObjectCursor(n, null);
        } else { // value node
            _nodeCursor = new com.townmc.utils.jackson.databind.node.NodeCursor.RootCursor(n, null);
        }
    }
    ...
    public Object getEmbeddedObject()
    {
        if (!_closed) {
            ...
            if (n != null) {
                if (n.isPojo()) {
                    return ((com.townmc.utils.jackson.databind.node.POJONode) n).getPojo();
                }
                if (n.isBinary()) {
    ...
    public boolean isNaN() {
        if (!_closed) {
            JsonNode n = currentNode();
            if (n instanceof com.townmc.utils.jackson.databind.node.NumericNode) {

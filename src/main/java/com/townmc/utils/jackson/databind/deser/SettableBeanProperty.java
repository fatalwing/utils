...
import com.townmc.utils.jackson.databind.deser.impl.FailingDeserializer;
import com.townmc.utils.jackson.databind.deser.impl.NullsConstantProvider;
...
import com.townmc.utils.jackson.databind.util.ViewMatcher;
    ...
    implements java.io.Serializable
{
     ...
     * @since 2.9
     */
    protected final com.townmc.utils.jackson.databind.deser.NullValueProvider _nullProvider;
    ...
    /**
     * Constructor only used by {@link com.townmc.utils.jackson.databind.deser.impl.ObjectIdValueProperty}.
     * 
     * @since 2.3
     */
    ...
    protected SettableBeanProperty(SettableBeanProperty src,
            JsonDeserializer<?> deser, com.townmc.utils.jackson.databind.deser.NullValueProvider nuller)
    {
        super(src);
        _propName = src._propName;
        _type = src._type;
     ...
     * @since 2.9
     */
    public abstract SettableBeanProperty withNullProvider(com.townmc.utils.jackson.databind.deser.NullValueProvider nva);
     ...
     * @since 2.9
     */
    public com.townmc.utils.jackson.databind.deser.NullValueProvider getNullValueProvider() { return _nullProvider; }

...
import com.townmc.utils.jackson.databind.util.TokenBufferReadContext;
            ...
            case VALUE_EMBEDDED_OBJECT:
                {
                    ...
                    //    first
                    if (value instanceof com.townmc.utils.jackson.databind.util.RawValue) {
                        ((com.townmc.utils.jackson.databind.util.RawValue) value).serialize(gen);
...
*/
    ...
    public void writeRawValue(String text) throws IOException {
        _appendValue(JsonToken.VALUE_EMBEDDED_OBJECT, new com.townmc.utils.jackson.databind.util.RawValue(text));
    }
        ...
        extends ParserMinimalBase
    {
        ...
        public String getText()
        {
            ...
            if (_currToken == JsonToken.VALUE_STRING
                ...
                return com.townmc.utils.jackson.databind.util.ClassUtil.nullOrToString(ob);
            }
            if (_currToken == null) {
                return null;
            }

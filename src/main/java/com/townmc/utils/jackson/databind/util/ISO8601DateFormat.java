...
import com.townmc.utils.jackson.databind.util.ISO8601Utils;
 ...
 *
 * @see com.townmc.utils.jackson.databind.util.ISO8601Utils
 */
...
public class ISO8601DateFormat extends DateFormat
{
    ...
    public StringBuffer format(Date date, StringBuffer toAppendTo, FieldPosition fieldPosition) {
        toAppendTo.append(com.townmc.utils.jackson.databind.util.ISO8601Utils.format(date));
        return toAppendTo;
    }
    ...
    public Date parse(String source, ParsePosition pos) {
        try {
            return com.townmc.utils.jackson.databind.util.ISO8601Utils.parse(source, pos);
        }

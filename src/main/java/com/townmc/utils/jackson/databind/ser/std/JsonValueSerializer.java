 ...
 * {@link com.townmc.utils.jackson.annotation.JsonValue} annotation to
    ...
    implements ContextualSerializer, JsonFormatVisitable, SchemaAware
{
     ...
     *    {@link com.townmc.utils.jackson.databind.annotation.JsonSerialize#using}), otherwise
     *    null
     *    
        ...
        throws JsonMappingException
    {
        ...
        return com.townmc.utils.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
    }

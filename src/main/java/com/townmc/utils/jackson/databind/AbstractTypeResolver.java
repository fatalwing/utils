...
public abstract class AbstractTypeResolver
{
     ...
     */
    public com.townmc.utils.jackson.databind.JavaType findTypeMapping(DeserializationConfig config, com.townmc.utils.jackson.databind.JavaType type) {
        return null;
    }

    /**
     * Older variant of {@link #resolveAbstractType(DeserializationConfig, com.townmc.utils.jackson.databind.BeanDescription)};
     * obsoleted in 2.7
     *
     * @deprecated since 2.8 (may be removed from 2.9 or later)
     */
    @Deprecated
    public com.townmc.utils.jackson.databind.JavaType resolveAbstractType(DeserializationConfig config,
                                                                       com.townmc.utils.jackson.databind.JavaType type) {
        return null;
    }

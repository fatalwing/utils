...
public abstract class HandlerInstantiator
{
     ...
     */
    public abstract TypeResolverBuilder<?> typeResolverBuilderInstance(com.townmc.utils.jackson.databind.cfg.MapperConfig<?> config,
     ...
     * @return TypeResolverBuilder instance to use
     */
    public abstract TypeIdResolver typeIdResolverInstance(com.townmc.utils.jackson.databind.cfg.MapperConfig<?> config,
                                                          Annotated annotated, Class<?> resolverClass);

    /**
     * Method called to construct an instance of ValueInstantiator of specified type.
     */
    public ValueInstantiator valueInstantiatorInstance(com.townmc.utils.jackson.databind.cfg.MapperConfig<?> config,
                                                       Annotated annotated, Class<?> resolverClass) {
        return null;
    }
     ...
     * @since 2.0
     */
    public ObjectIdGenerator<?> objectIdGeneratorInstance(com.townmc.utils.jackson.databind.cfg.MapperConfig<?> config,
                                                          Annotated annotated, Class<?> implClass) {
        return null;
    }

    public ObjectIdResolver resolverIdGeneratorInstance(com.townmc.utils.jackson.databind.cfg.MapperConfig<?> config, Annotated annotated, Class<?> implClass) {
        return null;
    }
     ...
     * @since 2.1
     */
    public PropertyNamingStrategy namingStrategyInstance(com.townmc.utils.jackson.databind.cfg.MapperConfig<?> config,
                                                         Annotated annotated, Class<?> implClass) {
        return null;
    }
     ...
     * @since 2.2
     */
    public Converter<?,?> converterInstance(com.townmc.utils.jackson.databind.cfg.MapperConfig<?> config,
                                            Annotated annotated, Class<?> implClass) {
        return null;
    }
     ...
     * {@link com.townmc.utils.jackson.annotation.JsonInclude} annotation (or
     * equivalent).
     *<p> 

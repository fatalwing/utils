 ...
 * is that {@link com.townmc.utils.jackson.databind.ObjectMapper} is constructed and passed as
 * the codec to use.
 */
    ...
    extends JsonFactory
{
    ...
    public MappingJsonFactory(com.townmc.utils.jackson.databind.ObjectMapper mapper)
    {
        super(mapper);
        if (mapper == null) {
            setCodec(new com.townmc.utils.jackson.databind.ObjectMapper(this));
        }
    }

    public MappingJsonFactory(JsonFactory src, com.townmc.utils.jackson.databind.ObjectMapper mapper)
    {
        super(src, mapper);
        if (mapper == null) {
            setCodec(new com.townmc.utils.jackson.databind.ObjectMapper(this));
     ...
     */
    @Override
    public final com.townmc.utils.jackson.databind.ObjectMapper getCodec() { return (ObjectMapper) _objectCodec; }

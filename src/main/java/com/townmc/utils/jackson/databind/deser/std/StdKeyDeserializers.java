...
import com.townmc.utils.jackson.databind.deser.std.StdKeyDeserializer;
...
import com.townmc.utils.jackson.databind.util.EnumResolver;
    ...
    implements KeyDeserializers, java.io.Serializable
{
    ...
    public static KeyDeserializer constructEnumKeyDeserializer(EnumResolver enumResolver) {
        return new com.townmc.utils.jackson.databind.deser.std.StdKeyDeserializer.EnumKD(enumResolver, null);
    }

    public static KeyDeserializer constructEnumKeyDeserializer(EnumResolver enumResolver,
            AnnotatedMethod factory) {
        return new com.townmc.utils.jackson.databind.deser.std.StdKeyDeserializer.EnumKD(enumResolver, factory);
    }
    ...
    {
        return new com.townmc.utils.jackson.databind.deser.std.StdKeyDeserializer.DelegatingKD(type.getRawClass(), deser);
    }
            ...
            JavaType type)
    {
        ...
        if (ctor != null) {
            ...
            return new com.townmc.utils.jackson.databind.deser.std.StdKeyDeserializer.StringCtorKeyDeserializer(ctor);
        }
        ...
        if (m != null){
            ...
            return new com.townmc.utils.jackson.databind.deser.std.StdKeyDeserializer.StringFactoryKeyDeserializer(m);
        }
        // nope, no such luck...
        return null;
    }

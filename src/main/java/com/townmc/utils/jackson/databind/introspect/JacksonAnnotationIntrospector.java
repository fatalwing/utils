...
import com.townmc.utils.jackson.databind.annotation.*;
...
import com.townmc.utils.jackson.databind.introspect.VirtualAnnotatedMember;
...
import com.townmc.utils.jackson.databind.ser.VirtualBeanPropertyWriter;
import com.townmc.utils.jackson.databind.ser.impl.AttributePropertyWriter;
import com.townmc.utils.jackson.databind.ser.std.RawSerializer;
    ...
    implements java.io.Serializable
{
    ...
    @Override
    public Object findFilterId(com.townmc.utils.jackson.databind.introspect.Annotated a) {
    ...
    @Override
    public String findImplicitPropertyName(com.townmc.utils.jackson.databind.introspect.AnnotatedMember m) {
        PropertyName n = _findConstructorName(m);
        return (n == null) ? null : n.getSimpleName();
    }

    @Override
    public List<PropertyName> findPropertyAliases(com.townmc.utils.jackson.databind.introspect.Annotated m) {
    ...
    @Override
    public JsonProperty.Access findPropertyAccess(com.townmc.utils.jackson.databind.introspect.Annotated m) {
        JsonProperty ann = _findAnnotation(m, JsonProperty.class);
        if (ann != null) {
            return ann.access();
        }
    ...
    public JacksonInject.Value findInjectableValue(com.townmc.utils.jackson.databind.introspect.AnnotatedMember m) {
        ...
        if (!v.hasId()) {
            ...
            if (!(m instanceof com.townmc.utils.jackson.databind.introspect.AnnotatedMethod)) {
                ...
                com.townmc.utils.jackson.databind.introspect.AnnotatedMethod am = (com.townmc.utils.jackson.databind.introspect.AnnotatedMethod) m;
    ...
    public TypeResolverBuilder<?> findPropertyContentTypeResolver(MapperConfig<?> config,
                                                                  com.townmc.utils.jackson.databind.introspect.AnnotatedMember am, JavaType containerType)
    {
    ...
    public com.townmc.utils.jackson.databind.introspect.ObjectIdInfo findObjectIdInfo(com.townmc.utils.jackson.databind.introspect.Annotated ann) {
        ...
        return new com.townmc.utils.jackson.databind.introspect.ObjectIdInfo(name, info.scope(), info.generator(), info.resolver());
    }

    @Override
    public com.townmc.utils.jackson.databind.introspect.ObjectIdInfo findObjectReferenceInfo(com.townmc.utils.jackson.databind.introspect.Annotated ann, com.townmc.utils.jackson.databind.introspect.ObjectIdInfo objectIdInfo) {
    ...
    */
    ...
    @Override
    public Object findSerializer(com.townmc.utils.jackson.databind.introspect.Annotated a)
    {
    ...
    private JsonInclude.Value _refinePropertyInclusion(com.townmc.utils.jackson.databind.introspect.Annotated a, JsonInclude.Value value) {
        JsonSerialize ann = _findAnnotation(a, JsonSerialize.class);
        if (ann != null) {
            switch (ann.include()) {
            case ALWAYS:
    ...
    public JavaType refineSerializationType(final MapperConfig<?> config,
                                            final com.townmc.utils.jackson.databind.introspect.Annotated a, final JavaType baseType) throws JsonMappingException
    {
    ...
    public Class<?> findSerializationType(com.townmc.utils.jackson.databind.introspect.Annotated am) {
        return null;
    }
    ...
    private final Boolean _findSortAlpha(com.townmc.utils.jackson.databind.introspect.Annotated ann) {
    ...
    protected BeanPropertyWriter _constructVirtualProperty(JsonAppend.Attr attr,
                                                           MapperConfig<?> config, com.townmc.utils.jackson.databind.introspect.AnnotatedClass ac, JavaType type)
    {
        ...
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember member = new com.townmc.utils.jackson.databind.introspect.VirtualAnnotatedMember(ac, ac.getRawType(),
                attrName, type);
    ...
    protected BeanPropertyWriter _constructVirtualProperty(JsonAppend.Prop prop,
            MapperConfig<?> config, com.townmc.utils.jackson.databind.introspect.AnnotatedClass ac)
    {
        ...
        // now, then, we need a placeholder for member (no real Field/Method):
        com.townmc.utils.jackson.databind.introspect.AnnotatedMember member = new VirtualAnnotatedMember(ac, ac.getRawType(),
    ...
    @Override
    public Object findContentDeserializer(com.townmc.utils.jackson.databind.introspect.Annotated a)
    {
        JsonDeserialize ann = _findAnnotation(a, JsonDeserialize.class);
        if (ann != null) {
            @SuppressWarnings("rawtypes")
    ...
    @Override
    public JsonPOJOBuilder.Value findPOJOBuilderConfig(com.townmc.utils.jackson.databind.introspect.AnnotatedClass ac)
    {
    ...
    public boolean hasCreatorAnnotation(com.townmc.utils.jackson.databind.introspect.Annotated a)
    {
         ...
         */
         ...
         if (_cfgConstructorPropertiesImpliesCreator ) {
             if (a instanceof com.townmc.utils.jackson.databind.introspect.AnnotatedConstructor) {
    ...
    @Override
    public JsonCreator.Mode findCreatorAnnotation(MapperConfig<?> config, com.townmc.utils.jackson.databind.introspect.Annotated a) {
        JsonCreator ann = _findAnnotation(a, JsonCreator.class);
        if (ann != null) {
            return ann.mode();
        }
    ...
    protected boolean _isIgnorable(com.townmc.utils.jackson.databind.introspect.Annotated a)
    {
    ...
    protected PropertyName _findConstructorName(com.townmc.utils.jackson.databind.introspect.Annotated a)
    {
        if (a instanceof com.townmc.utils.jackson.databind.introspect.AnnotatedParameter) {
            com.townmc.utils.jackson.databind.introspect.AnnotatedParameter p = (AnnotatedParameter) a;

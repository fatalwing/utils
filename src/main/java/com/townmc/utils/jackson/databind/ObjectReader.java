...
import com.townmc.utils.jackson.core.filter.FilteringParserDelegate;
import com.townmc.utils.jackson.core.filter.JsonPointerBasedFilter;
...
import com.townmc.utils.jackson.databind.deser.DataFormatReaders;
import com.townmc.utils.jackson.databind.deser.DefaultDeserializationContext;
import com.townmc.utils.jackson.databind.deser.DeserializationProblemHandler;
import com.townmc.utils.jackson.databind.node.JsonNodeFactory;
import com.townmc.utils.jackson.databind.node.TreeTraversingParser;
 ...
 * Instances are initially constructed by {@link com.townmc.utils.jackson.databind.ObjectMapper} and can be
    ...
    implements Versioned, Serializable // since 2.1
{
    ...
    private final static com.townmc.utils.jackson.databind.JavaType JSON_NODE_TYPE = SimpleType.constructUnsafe(com.townmc.utils.jackson.databind.JsonNode.class);
     ...
     */
    protected final com.townmc.utils.jackson.databind.JavaType _valueType;
     ...
     * {@link com.townmc.utils.jackson.databind.type.ArrayType}; array
     ...
     * Passed by {@link com.townmc.utils.jackson.databind.ObjectMapper}, shared with it.
     */
    ...
    /**
     * Constructor used by {@link com.townmc.utils.jackson.databind.ObjectMapper} for initial instantiation
     */
    protected ObjectReader(com.townmc.utils.jackson.databind.ObjectMapper mapper, DeserializationConfig config) {
    ...
    protected ObjectReader(ObjectReader base, DeserializationConfig config,
                           com.townmc.utils.jackson.databind.JavaType valueType, JsonDeserializer<Object> rootDeser, Object valueToUpdate,
                           FormatSchema schema, InjectableValues injectableValues,
     ...
     * passed {@link JsonNodeFactory} for constructing {@link com.townmc.utils.jackson.databind.JsonNode}
     * instances.
     *<p>
     * Note that the method does NOT change state of this reader, but
     * rather construct and returns a newly configured instance.
     ...
     * @since 2.5
     */
    public ObjectReader forType(com.townmc.utils.jackson.databind.JavaType valueType)
    {
    ...
    /**
     * @deprecated since 2.5 Use {@link #forType(com.townmc.utils.jackson.databind.JavaType)} instead
     */
    @Deprecated
    public ObjectReader withType(com.townmc.utils.jackson.databind.JavaType valueType) {
    ...
    public ObjectReader withValueToUpdate(Object value)
    {
        ...
        com.townmc.utils.jackson.databind.JavaType t;
    ...
    public <T> T readValue(JsonParser p, ResolvedType valueType) throws IOException {
        return (T) forType((com.townmc.utils.jackson.databind.JavaType)valueType).readValue(p);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T readValue(JsonParser p, com.townmc.utils.jackson.databind.JavaType valueType) throws IOException {
        return (T) forType(valueType).readValue(p);
    }
     ...
     * (data-format specific) parser is given.
     */
    public <T> Iterator<T> readValues(JsonParser p, com.townmc.utils.jackson.databind.JavaType valueType) throws IOException {
        return forType(valueType).readValues(p);
    }
    ...
    @Override
    public com.townmc.utils.jackson.databind.JsonNode createArrayNode() {
        return _config.getNodeFactory().arrayNode();
    }

    @Override
    public com.townmc.utils.jackson.databind.JsonNode createObjectNode() {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T readValue(com.townmc.utils.jackson.databind.JsonNode src)
        throws IOException
    {
        if (_dataFormatReaders != null) {
            _reportUndetectableSource(src);
     ...
     * {@link com.townmc.utils.jackson.databind.JsonNode} instance.
     */
     ...
     * {@link com.townmc.utils.jackson.databind.JsonNode} instance.
     */
    public com.townmc.utils.jackson.databind.JsonNode readTree(String json) throws IOException
    {
        if (_dataFormatReaders != null) {
    ...
    public com.townmc.utils.jackson.databind.JsonNode readTree(DataInput src) throws IOException
    {
        if (_dataFormatReaders != null) {
            _reportUndetectableSource(src);
        }
    ...
    protected final com.townmc.utils.jackson.databind.JsonNode _bindAndCloseAsTree(JsonParser p0) throws IOException {
        try (JsonParser p = p0) {
            return _bindAsTree(p);
        }
    }

    protected final com.townmc.utils.jackson.databind.JsonNode _bindAsTree(JsonParser p) throws IOException
    {
        ...
        return (com.townmc.utils.jackson.databind.JsonNode) result;
    }
    ...
    protected Object _unwrapAndDeserialize(JsonParser p, DeserializationContext ctxt,
                                           com.townmc.utils.jackson.databind.JavaType rootType, JsonDeserializer<Object> deser) throws IOException
    {
        ...
        throws JsonMappingException
    {
        ...
        com.townmc.utils.jackson.databind.JavaType t = _valueType;
        if (t == null) {
            ctxt.reportBadDefinition((com.townmc.utils.jackson.databind.JavaType) null,

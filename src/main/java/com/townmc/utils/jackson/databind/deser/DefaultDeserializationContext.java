...
import com.townmc.utils.jackson.annotation.ObjectIdGenerator.IdKey;
...
import com.townmc.utils.jackson.databind.deser.ResolvableDeserializer;
import com.townmc.utils.jackson.databind.deser.UnresolvedForwardReference;
import com.townmc.utils.jackson.databind.deser.impl.ReadableObjectId;
import com.townmc.utils.jackson.databind.deser.impl.ReadableObjectId.Referring;
    ...
    implements java.io.Serializable // since 2.1
{
     ...
     */
    protected DefaultDeserializationContext(com.townmc.utils.jackson.databind.deser.DeserializerFactory df, com.townmc.utils.jackson.databind.deser.DeserializerCache cache) {
        super(df, cache);
    }
    ...
    protected DefaultDeserializationContext(DefaultDeserializationContext src,
            com.townmc.utils.jackson.databind.deser.DeserializerFactory factory) {
        super(src, factory);
    }
    ...
    @Override
    public void checkUnresolvedObjectId() throws com.townmc.utils.jackson.databind.deser.UnresolvedForwardReference
    {
        if (_objectIds == null) {
            return;
        }
        ...
        com.townmc.utils.jackson.databind.deser.UnresolvedForwardReference exception = null;
        ...
        throws JsonMappingException
    {
        ...
        if (deser instanceof com.townmc.utils.jackson.databind.deser.ResolvableDeserializer) {
            ((com.townmc.utils.jackson.databind.deser.ResolvableDeserializer) deser).resolve(this);
        }
     ...
     */
    public abstract DefaultDeserializationContext with(com.townmc.utils.jackson.databind.deser.DeserializerFactory factory);
    ...
    public final static class Impl extends DefaultDeserializationContext
    {
         ...
         */
        public Impl(com.townmc.utils.jackson.databind.deser.DeserializerFactory df) {
            super(df, null);
        }
        ...
        protected Impl(Impl src, com.townmc.utils.jackson.databind.deser.DeserializerFactory factory) {
            super(src, factory);
        }

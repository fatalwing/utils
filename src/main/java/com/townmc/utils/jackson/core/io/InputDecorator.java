    ...
    implements Serializable // since 2.1
{
    ...
    /**
     * Method called by {@link com.townmc.utils.jackson.core.JsonFactory} instance when
     ...
     */
    public abstract InputStream decorate(com.townmc.utils.jackson.core.io.IOContext ctxt, InputStream in)
        throws IOException;
     ...
     */
    public abstract InputStream decorate(com.townmc.utils.jackson.core.io.IOContext ctxt, byte[] src, int offset, int length)
        throws IOException;
     ...
     * @since 2.8
     */
    public DataInput decorate(com.townmc.utils.jackson.core.io.IOContext ctxt, DataInput input)
        throws IOException {

package com.townmc.utils.jackson.core.format;

import java.io.*;
import java.util.*;

import com.townmc.utils.jackson.core.*;
import com.townmc.utils.jackson.core.format.DataFormatMatcher;
...
public class DataFormatDetector
{
     ...
     * Default value is {@link com.townmc.utils.jackson.core.format.MatchStrength#SOLID_MATCH},
     */
    protected final com.townmc.utils.jackson.core.format.MatchStrength _optimalMatch;

    /**
     * Strength of minimal match we accept as the answer, unless
     * better matches are found. 
     * Default value is {@link com.townmc.utils.jackson.core.format.MatchStrength#WEAK_MATCH},
     */
    protected final com.townmc.utils.jackson.core.format.MatchStrength _minimalMatch;
    ...
    public DataFormatDetector(JsonFactory... detectors) {
        this(detectors, com.townmc.utils.jackson.core.format.MatchStrength.SOLID_MATCH, com.townmc.utils.jackson.core.format.MatchStrength.WEAK_MATCH,
     ...
     */
    public DataFormatDetector withOptimalMatch(com.townmc.utils.jackson.core.format.MatchStrength optMatch) {
     ...
     */
    public DataFormatDetector withMinimalMatch(com.townmc.utils.jackson.core.format.MatchStrength minMatch) {
    ...
    private DataFormatDetector(JsonFactory[] detectors,
                               com.townmc.utils.jackson.core.format.MatchStrength optMatch, com.townmc.utils.jackson.core.format.MatchStrength minMatch, int maxInputLookahead) {
     ...
     */
    public com.townmc.utils.jackson.core.format.DataFormatMatcher findFormat(InputStream in) throws IOException {
        return _findFormat(new com.townmc.utils.jackson.core.format.InputAccessor.Std(in, new byte[_maxInputLookahead]));
    }
     ...
     *    where no match (with specified minimal match strength) is found.
     */
    public com.townmc.utils.jackson.core.format.DataFormatMatcher findFormat(byte[] fullInputData) throws IOException {
        return _findFormat(new com.townmc.utils.jackson.core.format.InputAccessor.Std(fullInputData));
    }
     ...
     * @since 2.1
     */
    public com.townmc.utils.jackson.core.format.DataFormatMatcher findFormat(byte[] fullInputData, int offset, int len) throws IOException {
        return _findFormat(new com.townmc.utils.jackson.core.format.InputAccessor.Std(fullInputData, offset, len));
    }
    ...
    private DataFormatMatcher _findFormat(InputAccessor.Std acc) throws IOException {
        ...
        com.townmc.utils.jackson.core.format.MatchStrength bestMatchStrength = null;

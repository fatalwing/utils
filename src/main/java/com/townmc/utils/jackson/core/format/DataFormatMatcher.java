...
import com.townmc.utils.jackson.core.format.DataFormatDetector;
...
public class DataFormatMatcher
{
     ...
     */
    protected final com.townmc.utils.jackson.core.format.MatchStrength _matchStrength;
    
    protected DataFormatMatcher(InputStream in, byte[] buffered,
            int bufferedStart, int bufferedLength,
            JsonFactory match, com.townmc.utils.jackson.core.format.MatchStrength strength)
    {
        _originalStream = in;
     ...
     * will return {@link com.townmc.utils.jackson.core.format.MatchStrength#INCONCLUSIVE}.
     */
    public com.townmc.utils.jackson.core.format.MatchStrength getMatchStrength() {

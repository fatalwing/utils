...
import com.townmc.utils.jackson.core.base.GeneratorBase;
...
import com.townmc.utils.jackson.core.json.UTF8JsonGenerator;
import com.townmc.utils.jackson.core.json.WriterBasedJsonGenerator;
...
public abstract class JsonGeneratorImpl extends GeneratorBase
{
    ...
    protected void _verifyPrettyValueWrite(String typeMsg, int status) throws IOException
    {
        ...
        switch (status) {
        case com.townmc.utils.jackson.core.json.JsonWriteContext.STATUS_OK_AFTER_COMMA: // array
            _cfgPrettyPrinter.writeArrayValueSeparator(this);
            break;
        case com.townmc.utils.jackson.core.json.JsonWriteContext.STATUS_OK_AFTER_COLON:
            _cfgPrettyPrinter.writeObjectFieldValueSeparator(this);
            break;
        case com.townmc.utils.jackson.core.json.JsonWriteContext.STATUS_OK_AFTER_SPACE:

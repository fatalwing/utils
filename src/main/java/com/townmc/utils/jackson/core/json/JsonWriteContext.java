...
public class JsonWriteContext extends JsonStreamContext
{
    ...
    protected JsonWriteContext(int type, JsonWriteContext parent, com.townmc.utils.jackson.core.json.DupDetector dups) {
        super();
        _type = type;
        _parent = parent;
        _dups = dups;
    ...
    public JsonWriteContext withDupDetector(com.townmc.utils.jackson.core.json.DupDetector dups) {
        _dups = dups;
        return this;
    }
    ...
    public static JsonWriteContext createRootContext(com.townmc.utils.jackson.core.json.DupDetector dd) {

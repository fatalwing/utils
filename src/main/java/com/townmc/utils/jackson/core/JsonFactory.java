...
import com.townmc.utils.jackson.core.format.InputAccessor;
import com.townmc.utils.jackson.core.format.MatchStrength;
import com.townmc.utils.jackson.core.io.*;
import com.townmc.utils.jackson.core.json.*;
import com.townmc.utils.jackson.core.json.async.NonBlockingJsonParser;
import com.townmc.utils.jackson.core.sym.ByteQuadsCanonicalizer;
import com.townmc.utils.jackson.core.sym.CharsToNameCanonicalizer;
import com.townmc.utils.jackson.core.util.BufferRecycler;
import com.townmc.utils.jackson.core.util.DefaultPrettyPrinter;

/**
 * The main factory class of Jackson package, used to configure and
 * construct reader (aka parser, {@link com.townmc.utils.jackson.core.JsonParser})
        ...
        Serializable // since 2.1 (for Android, mostly)
{
     ...
     * by default.
     */
    protected final static int DEFAULT_PARSER_FEATURE_FLAGS = com.townmc.utils.jackson.core.JsonParser.Feature.collectDefaults();
     ...
     * {@link com.townmc.utils.jackson.core.async.NonBlockingInputFeeder}.
     *
     * @since 2.9
     */
     ...
     * {@link com.townmc.utils.jackson.core.JsonParser} produced by this factory would accept, if any;
     ...
     * using {@link com.townmc.utils.jackson.core.JsonParser} constructed by this factory
     ...
     * (check {@link com.townmc.utils.jackson.core.JsonParser.Feature} for list of features)
     */
     ...
     * (check {@link com.townmc.utils.jackson.core.JsonParser.Feature} for list of features)
     */
    public final JsonFactory configure(com.townmc.utils.jackson.core.JsonParser.Feature f, boolean state) {
        return state ? enable(f) : disable(f);
    }
     ...
     * (check {@link com.townmc.utils.jackson.core.JsonParser.Feature} for list of features)
     */
    public JsonFactory enable(com.townmc.utils.jackson.core.JsonParser.Feature f) {
     ...
     * (check {@link com.townmc.utils.jackson.core.JsonParser.Feature} for list of features)
     */
    public JsonFactory disable(com.townmc.utils.jackson.core.JsonParser.Feature f) {
        _parserFeatures &= ~f.getMask();
        return this;
    }
     ...
     * Checked whether specified parser feature is enabled.
     */
    public final boolean isEnabled(com.townmc.utils.jackson.core.JsonParser.Feature f) {
     ...
     * a <code>com.townmc.utils.jackson.databind.ObjectMapper</code>)
     * with this factory (and more importantly, parsers and generators
     * it constructs). This is needed to use data-binding methods
     * of {@link com.townmc.utils.jackson.core.JsonParser} and {@link JsonGenerator} instances.
     */
     ...
     * @since 2.1
     */
    public com.townmc.utils.jackson.core.JsonParser createParser(File f) throws IOException, JsonParseException {
     ...
     * @since 2.1
     */
    public com.townmc.utils.jackson.core.JsonParser createParser(URL url) throws IOException, JsonParseException {
     ...
     * if (and only if) {@link com.townmc.utils.jackson.core.JsonParser.Feature#AUTO_CLOSE_SOURCE}
     * is enabled.
     *<p>
     *
     ...
     * @since 2.1
     */
    public com.townmc.utils.jackson.core.JsonParser createParser(InputStream in) throws IOException, JsonParseException {
     ...
     * @since 2.1
     */
    public com.townmc.utils.jackson.core.JsonParser createParser(Reader r) throws IOException, JsonParseException {
     ...
     * @since 2.1
     */
    public com.townmc.utils.jackson.core.JsonParser createParser(byte[] data) throws IOException, JsonParseException {
     ...
     * @since 2.1
     */
    public com.townmc.utils.jackson.core.JsonParser createParser(byte[] data, int offset, int len) throws IOException, JsonParseException {
        IOContext ctxt = _createContext(data, true);
     ...
     * @since 2.1
     */
    public com.townmc.utils.jackson.core.JsonParser createParser(String content) throws IOException, JsonParseException {
     ...
     * @since 2.4
     */
    public com.townmc.utils.jackson.core.JsonParser createParser(char[] content) throws IOException {
     ...
     * @since 2.4
     */
    public com.townmc.utils.jackson.core.JsonParser createParser(char[] content, int offset, int len) throws IOException {
     ...
     * @since 2.8
     */
    public com.townmc.utils.jackson.core.JsonParser createParser(DataInput in) throws IOException {
        IOContext ctxt = _createContext(in, false);
        return _createParser(_decorate(in, ctxt), ctxt);
    }
     ...
     * via {@link com.townmc.utils.jackson.core.async.ByteArrayFeeder}
     * interface (accessed using {@link com.townmc.utils.jackson.core.JsonParser#getNonBlockingInputFeeder()}
     ...
     * @since 2.9
     */
    public com.townmc.utils.jackson.core.JsonParser createNonBlockingByteArrayParser() throws IOException
    {
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.core.JsonParser createJsonParser(File f) throws IOException, JsonParseException {
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.core.JsonParser createJsonParser(URL url) throws IOException, JsonParseException {
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.core.JsonParser createJsonParser(InputStream in) throws IOException, JsonParseException {
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.core.JsonParser createJsonParser(Reader r) throws IOException, JsonParseException {
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.core.JsonParser createJsonParser(byte[] data) throws IOException, JsonParseException {
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.core.JsonParser createJsonParser(byte[] data, int offset, int len) throws IOException, JsonParseException {
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.core.JsonParser createJsonParser(String content) throws IOException, JsonParseException {
     ...
     * @since 2.1
     */
    protected com.townmc.utils.jackson.core.JsonParser _createParser(InputStream in, IOContext ctxt) throws IOException {
     ...
     * @since 2.1
     */
    protected com.townmc.utils.jackson.core.JsonParser _createParser(Reader r, IOContext ctxt) throws IOException {
     ...
     * @since 2.4
     */
    protected com.townmc.utils.jackson.core.JsonParser _createParser(char[] data, int offset, int len, IOContext ctxt,
     ...
     * method available to users of factory implementations.
     */
    protected com.townmc.utils.jackson.core.JsonParser _createParser(byte[] data, int offset, int len, IOContext ctxt) throws IOException
    {

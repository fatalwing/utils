 ...
 * content being read or written (based on {@link com.townmc.utils.jackson.core.filter.TokenFilter}).
 * 
 * @since 2.6
 */
public class TokenFilterContext extends JsonStreamContext
{
     ...
     */
    protected com.townmc.utils.jackson.core.filter.TokenFilter _filter;
    ...
    protected TokenFilterContext(int type, TokenFilterContext parent,
                                 com.townmc.utils.jackson.core.filter.TokenFilter filter, boolean startHandled)
    {
        super();
        _type = type;
        _parent = parent;
    ...
    protected TokenFilterContext reset(int type,
                                       com.townmc.utils.jackson.core.filter.TokenFilter filter, boolean startWritten)
    {
        _type = type;
        _filter = filter;
        _index = -1;
    ...
    public static TokenFilterContext createRootContext(com.townmc.utils.jackson.core.filter.TokenFilter filter) {
        // true -> since we have no start/end marker, consider start handled
        return new TokenFilterContext(TYPE_ROOT, null, filter, true);
    }

    public TokenFilterContext createChildArrayContext(com.townmc.utils.jackson.core.filter.TokenFilter filter, boolean writeStart) {
    ...
    public TokenFilterContext createChildObjectContext(com.townmc.utils.jackson.core.filter.TokenFilter filter, boolean writeStart) {
        TokenFilterContext ctxt = _child;
        if (ctxt == null) {
    ...
    public com.townmc.utils.jackson.core.filter.TokenFilter setFieldName(String name) throws JsonProcessingException {
        _currentName = name;
     ...
     */
    public com.townmc.utils.jackson.core.filter.TokenFilter checkValue(com.townmc.utils.jackson.core.filter.TokenFilter filter) {
    ...
    {
        if ((_filter == null) || (_filter == com.townmc.utils.jackson.core.filter.TokenFilter.INCLUDE_ALL)) {
            return;
        }
        if (_parent != null) {

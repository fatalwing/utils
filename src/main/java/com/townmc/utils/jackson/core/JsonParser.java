...
import com.townmc.utils.jackson.core.JsonToken;
...
import com.townmc.utils.jackson.core.util.RequestPayload;
    ...
    implements Closeable, Versioned
{
    ...
    public enum Feature {
         ...
         */
          ...
          * Enabling this feature will expose "missing" values as {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NULL}
     ...
     * {@link com.townmc.utils.jackson.core.JsonParser.Feature}s
     * are enabled.
     */
     ...
     */
    public abstract com.townmc.utils.jackson.core.JsonToken nextToken() throws IOException;
     ...
     * and if {@link com.townmc.utils.jackson.core.JsonToken#FIELD_NAME} is returned, another
     ...
     *   parsers, {@link com.townmc.utils.jackson.core.JsonToken#NOT_AVAILABLE} if no tokens were
     *   available yet)
     */
    public abstract com.townmc.utils.jackson.core.JsonToken nextValue() throws IOException;

    /**
     * Method that fetches next token (as if calling {@link #nextToken}) and
     * verifies whether it is {@link com.townmc.utils.jackson.core.JsonToken#FIELD_NAME} with specified name
    ...
    public boolean nextFieldName(SerializableString str) throws IOException {
        return (nextToken() == com.townmc.utils.jackson.core.JsonToken.FIELD_NAME) && str.getValue().equals(getCurrentName());
    }

    /**
     * Method that fetches next token (as if calling {@link #nextToken}) and
     * verifies whether it is {@link com.townmc.utils.jackson.core.JsonToken#FIELD_NAME}; if it is,
     * returns same as {@link #getCurrentName()}, otherwise null.
     * 
     * @since 2.5
     */
    public String nextFieldName() throws IOException {
        return (nextToken() == com.townmc.utils.jackson.core.JsonToken.FIELD_NAME) ? getCurrentName() : null;
    }

    /**
     * Method that fetches next token (as if calling {@link #nextToken}) and
     * if it is {@link com.townmc.utils.jackson.core.JsonToken#VALUE_STRING} returns contained String value;
    ...
    public String nextTextValue() throws IOException {
        return (nextToken() == com.townmc.utils.jackson.core.JsonToken.VALUE_STRING) ? getText() : null;
    }

    /**
     * Method that fetches next token (as if calling {@link #nextToken}) and
     * if it is {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_INT} returns 32-bit int value;
    ...
    public int nextIntValue(int defaultValue) throws IOException {
        return (nextToken() == com.townmc.utils.jackson.core.JsonToken.VALUE_NUMBER_INT) ? getIntValue() : defaultValue;
    }

    /**
     * Method that fetches next token (as if calling {@link #nextToken}) and
     * if it is {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_INT} returns 64-bit long value;
     * otherwise returns specified default value
     * It is functionally equivalent to:
     *<pre>
    ...
    public long nextLongValue(long defaultValue) throws IOException {
        return (nextToken() == com.townmc.utils.jackson.core.JsonToken.VALUE_NUMBER_INT) ? getLongValue() : defaultValue;
    }

    /**
     * Method that fetches next token (as if calling {@link #nextToken}) and
     * if it is {@link com.townmc.utils.jackson.core.JsonToken#VALUE_TRUE} or {@link com.townmc.utils.jackson.core.JsonToken#VALUE_FALSE}
    ...
    public Boolean nextBooleanValue() throws IOException {
        com.townmc.utils.jackson.core.JsonToken t = nextToken();
        if (t == com.townmc.utils.jackson.core.JsonToken.VALUE_TRUE) { return Boolean.TRUE; }
        if (t == com.townmc.utils.jackson.core.JsonToken.VALUE_FALSE) { return Boolean.FALSE; }
        return null;
    }
     ...
     * {@link com.townmc.utils.jackson.core.JsonToken#START_OBJECT} or {@link com.townmc.utils.jackson.core.JsonToken#START_ARRAY}.
     * If not, it will do nothing.
     * After skipping, stream will point to <b>matching</b>
     * {@link com.townmc.utils.jackson.core.JsonToken#END_OBJECT} or {@link com.townmc.utils.jackson.core.JsonToken#END_ARRAY}
     ...
     * @since 2.8
     */
    public com.townmc.utils.jackson.core.JsonToken currentToken() {
        return getCurrentToken();
    }

    /**
     * Method similar to {@link #getCurrentToken()} but that returns an
     * <code>int</code> instead of {@link com.townmc.utils.jackson.core.JsonToken} (enum value).
     *<p>
     ...
     */
    public abstract com.townmc.utils.jackson.core.JsonToken getCurrentToken();
     ...
     * @since 2.6
     */
    public abstract boolean hasToken(com.townmc.utils.jackson.core.JsonToken t);

    /**
     * Specialized accessor that can be used to verify that the current
     * token indicates start array (usually meaning that current token
     * is {@link com.townmc.utils.jackson.core.JsonToken#START_ARRAY}) when start array is expected.
     ...
     *   start-array marker (such {@link com.townmc.utils.jackson.core.JsonToken#START_ARRAY});
     *   false if not.
     */
    public boolean isExpectedStartArrayToken() { return currentToken() == com.townmc.utils.jackson.core.JsonToken.START_ARRAY; }

    /**
     * Similar to {@link #isExpectedStartArrayToken()}, but checks whether stream
     * currently points to {@link com.townmc.utils.jackson.core.JsonToken#START_OBJECT}.
     *
     * @since 2.5
     */
    public boolean isExpectedStartObjectToken() { return currentToken() == com.townmc.utils.jackson.core.JsonToken.START_OBJECT; }
     ...
     * but often supported for {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_FLOAT}.
     ...
     */
    public abstract com.townmc.utils.jackson.core.JsonToken getLastClearedToken();
     ...
     * the current token: for {@link com.townmc.utils.jackson.core.JsonToken#FIELD_NAME}s it will
     ...
     * {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_INT} or
     * {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_FLOAT}, returns
     ...
     * token is of type {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_INT} and
     * it can be expressed as a value of Java byte primitive type.
     * It can also be called for {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_FLOAT};
    ...
    /**
     * Numeric accessor that can be called when the current
     * token is of type {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_FLOAT} and
     * it can be expressed as a Java float primitive type.
     * It can also be called for {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_INT};
    ...
    /**
     * Numeric accessor that can be called when the current
     * token is of type {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_FLOAT} or
     * {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_INT}. No under/overflow exceptions
     * are ever thrown.
     */
     ...
     * token is {@link com.townmc.utils.jackson.core.JsonToken#VALUE_TRUE} or
     * {@link com.townmc.utils.jackson.core.JsonToken#VALUE_FALSE}.
     *<p>
 ...
 an integer, but its value falls
    ...
    public boolean getBooleanValue() throws IOException {
        com.townmc.utils.jackson.core.JsonToken t = currentToken();
        if (t == com.townmc.utils.jackson.core.JsonToken.VALUE_TRUE) return true;
        if (t == com.townmc.utils.jackson.core.JsonToken.VALUE_FALSE) return false;
     ...
     * is {@link com.townmc.utils.jackson.core.JsonToken#VALUE_EMBEDDED_OBJECT}. For other token types,
     * null is returned.
     *<p>
     ...
     * (and for {@link com.townmc.utils.jackson.core.JsonToken#VALUE_EMBEDDED_OBJECT})
     ...
     * represented by root {@link com.townmc.utils.jackson.core.TreeNode} of resulting model.

...
import com.townmc.utils.jackson.core.filter.TokenFilterContext;
import com.townmc.utils.jackson.core.util.JsonParserDelegate;

import static com.townmc.utils.jackson.core.JsonTokenId.*;

/**
 * Specialized {@link JsonParserDelegate} that allows use of
 * {@link com.townmc.utils.jackson.core.filter.TokenFilter} for outputting a subset of content that
...
public class FilteringParserDelegate extends JsonParserDelegate
{
     ...
     */
    protected com.townmc.utils.jackson.core.filter.TokenFilter rootFilter;
     ...
     * full match (returning {@link com.townmc.utils.jackson.core.filter.TokenFilter#INCLUDE_ALL}) and no more
     ...
     */
    protected com.townmc.utils.jackson.core.filter.TokenFilterContext _headContext;
     ...
     */
    protected com.townmc.utils.jackson.core.filter.TokenFilterContext _exposedContext;
     ...
     */
    protected com.townmc.utils.jackson.core.filter.TokenFilter _itemFilter;
    
    /**
     * Number of tokens for which {@link com.townmc.utils.jackson.core.filter.TokenFilter#INCLUDE_ALL}
     * has been returned.
     */
    ...
    public FilteringParserDelegate(JsonParser p, com.townmc.utils.jackson.core.filter.TokenFilter f,
            boolean includePath, boolean allowMultipleMatches)
    {
        ...
        _itemFilter = f;
        _headContext = com.townmc.utils.jackson.core.filter.TokenFilterContext.createRootContext(f);
    ...
    public com.townmc.utils.jackson.core.filter.TokenFilter getFilter() { return rootFilter; }
    ...
    public JsonToken nextToken() throws IOException
    {
        ...
        if (!_allowMultipleMatches && (_currToken != null) && (_exposedContext == null)) {
            ...
            if (_currToken.isScalarValue() && !_headContext.isStartHandled() && !_includePath
                    && (_itemFilter == com.townmc.utils.jackson.core.filter.TokenFilter.INCLUDE_ALL)) {
                return (_currToken = null);
            }
        }
        // Anything buffered?
        com.townmc.utils.jackson.core.filter.TokenFilterContext ctxt = _exposedContext;
...
//                        if (t != JsonToken.START_ARRAY) {
        ...
        com.townmc.utils.jackson.core.filter.TokenFilter f;
        
        switch (t.id()) {
        case ID_START_ARRAY:
            f = _itemFilter;
            if (f == com.townmc.utils.jackson.core.filter.TokenFilter.INCLUDE_ALL) {
        ...
        case ID_END_OBJECT:
            {
                ...
                if ((f != null) && (f != com.townmc.utils.jackson.core.filter.TokenFilter.INCLUDE_ALL)) {
                    f.filterFinishArray();
                }
...
//                        if (_includeImmediateParent) { ...
     ...
     */
    protected final JsonToken _nextTokenWithBuffering(final com.townmc.utils.jackson.core.filter.TokenFilterContext buffRoot)
        throws IOException
    {
        main_loop:
        while (true) {
    ...
    private JsonToken _nextBuffered(com.townmc.utils.jackson.core.filter.TokenFilterContext buffRoot) throws IOException
    {
     ...
     * {@link com.townmc.utils.jackson.core.base.ParserMinimalBase}, to keep
     * state correct here.
     */
    @Override

...
public final class ByteArrayBuilder extends OutputStream
{
    ...
    private final com.townmc.utils.jackson.core.util.BufferRecycler _bufferRecycler;
    ...
    public ByteArrayBuilder(com.townmc.utils.jackson.core.util.BufferRecycler br) { this(br, INITIAL_BLOCK_SIZE); }
    public ByteArrayBuilder(int firstBlockSize) { this(null, firstBlockSize); }

    public ByteArrayBuilder(com.townmc.utils.jackson.core.util.BufferRecycler br, int firstBlockSize) {
        _bufferRecycler = br;
        _currBlock = (br == null) ? new byte[firstBlockSize] : br.allocByteBuffer(com.townmc.utils.jackson.core.util.BufferRecycler.BYTE_WRITE_CONCAT_BUFFER);
    }

package com.townmc.utils.jackson.core.json.async;

import java.io.IOException;
import java.io.OutputStream;

import com.townmc.utils.jackson.core.*;
import com.townmc.utils.jackson.core.async.ByteArrayFeeder;
...
import com.townmc.utils.jackson.core.json.async.NonBlockingJsonParserBase;
...
//        case MINOR_COMMENT_LEADING_SLASH: // not legal, but use default error
    ...
    private final JsonToken _finishHashComment(int fromMinorState) throws IOException
    {
        ...
        if (!Feature.ALLOW_YAML_COMMENTS.enabledIn(_features)) {

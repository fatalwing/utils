...
public class JsonProcessingException extends java.io.IOException
{
    ...
    protected com.townmc.utils.jackson.core.JsonLocation _location;

    protected JsonProcessingException(String msg, com.townmc.utils.jackson.core.JsonLocation loc, Throwable rootCause) {
    ...
    protected JsonProcessingException(String msg, com.townmc.utils.jackson.core.JsonLocation loc) {
        this(msg, loc, null);
    }
    ...
    public com.townmc.utils.jackson.core.JsonLocation getLocation() { return _location; }

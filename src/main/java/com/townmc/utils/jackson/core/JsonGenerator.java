...
import com.townmc.utils.jackson.core.Base64Variant;
import com.townmc.utils.jackson.core.FormatFeature;
import com.townmc.utils.jackson.core.FormatSchema;
import com.townmc.utils.jackson.core.JsonFactory;
import com.townmc.utils.jackson.core.JsonParser;
import com.townmc.utils.jackson.core.JsonParser.NumberType;
import com.townmc.utils.jackson.core.JsonToken;
import com.townmc.utils.jackson.core.ObjectCodec;
...
import com.townmc.utils.jackson.core.type.WritableTypeId.Inclusion;
import com.townmc.utils.jackson.core.util.VersionUtil;

import static com.townmc.utils.jackson.core.JsonTokenId.*;
    ...
    implements Closeable, Flushable, Versioned
{
    ...
    public enum Feature {
         ...
         * {@link com.townmc.utils.jackson.core.JsonToken#START_ARRAY} or {@link com.townmc.utils.jackson.core.JsonToken#START_OBJECT}
...
// 23-Nov-2015, tatu: for [core#223], if and when it gets implemented
         ...
         * by {@link Writer} into 4-byte UTF-8 sequence eventually)
         * is used.
         *<p>
...
//        ESCAPE_UTF8_SURROGATES(false),
     ...
     */
    public abstract JsonGenerator setCodec(com.townmc.utils.jackson.core.ObjectCodec oc);
    ...
    /**
     * Bulk access method for getting state of all {@link com.townmc.utils.jackson.core.FormatFeature}s, format-specific
     * on/off configuration settings.
     * 
     * @return Bit mask that defines current states of all standard {@link com.townmc.utils.jackson.core.FormatFeature}s.
     * 
     * @since 2.6
     */
    ...
    /**
     * Bulk set method for (re)setting states of {@link com.townmc.utils.jackson.core.FormatFeature}s,
     ...
     */
    public void setSchema(com.townmc.utils.jackson.core.FormatSchema schema) {
     ...
     * @since 2.1
     */
    public com.townmc.utils.jackson.core.FormatSchema getSchema() { return null; }
     ...
     * ({@link com.townmc.utils.jackson.core.util.DefaultPrettyPrinter}).
     *
     * @return Generator itself (this), to allow chaining
     */
     ...
     * array (sequence of {@link com.townmc.utils.jackson.core.JsonToken#START_ARRAY}, zero or
     * more {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_INT}, {@link com.townmc.utils.jackson.core.JsonToken#END_ARRAY})
     *
     * @since 2.8
     *
     ...
     * Value write method that can be called to write a single
     * array (sequence of {@link com.townmc.utils.jackson.core.JsonToken#START_ARRAY}, zero or
     * more {@link com.townmc.utils.jackson.core.JsonToken#VALUE_NUMBER_FLOAT}, {@link com.townmc.utils.jackson.core.JsonToken#END_ARRAY})
     *
     * @since 2.8
     *
     * @param array Array that contains values to write
     ...
     * linefeeds. However, all {@link com.townmc.utils.jackson.core.JsonParser} implementations
     ...
     */
    public abstract void writeBinary(com.townmc.utils.jackson.core.Base64Variant bv,
                                     byte[] data, int offset, int len) throws IOException;

    /**
     * Similar to {@link #writeBinary(com.townmc.utils.jackson.core.Base64Variant,byte[],int,int)},
    ...
    /**
     * Similar to {@link #writeBinary(com.townmc.utils.jackson.core.Base64Variant,InputStream,int)},
     * but assumes default to using the Jackson default Base64 variant 
     * (which is {@link Base64Variants#MIME_NO_LINEFEEDS}).
     * 
    ...
    /**
     * Method similar to {@link #writeBinary(com.townmc.utils.jackson.core.Base64Variant,byte[],int,int)},
    ...
    public WritableTypeId writeTypePrefix(WritableTypeId typeIdDef) throws IOException
    {
        ...
        final com.townmc.utils.jackson.core.JsonToken valueShape = typeIdDef.valueShape;
        if (canWriteTypeId()) {
            ...
            if ((valueShape != com.townmc.utils.jackson.core.JsonToken.START_OBJECT)
        ...
        if (valueShape == com.townmc.utils.jackson.core.JsonToken.START_OBJECT) {
            writeStartObject(typeIdDef.forValue);
        } else if (valueShape == com.townmc.utils.jackson.core.JsonToken.START_ARRAY) {
     ...
     */
    public void copyCurrentEvent(com.townmc.utils.jackson.core.JsonParser p) throws IOException
    {
        com.townmc.utils.jackson.core.JsonToken t = p.currentToken();
     ...
     * get copied:
     *<ul>
     * <li>{@link com.townmc.utils.jackson.core.JsonToken#START_OBJECT}:
     *   all events up to and including matching (closing)
     *   {@link com.townmc.utils.jackson.core.JsonToken#END_OBJECT} will be copied
     *  </li>
     * <li>{@link com.townmc.utils.jackson.core.JsonToken#START_ARRAY}
     *   all events up to and including matching (closing)
     *   {@link com.townmc.utils.jackson.core.JsonToken#END_ARRAY} will be copied
     *  </li>
     * <li>{@link com.townmc.utils.jackson.core.JsonToken#FIELD_NAME} the logical value (which
    ...
    public void copyCurrentStructure(JsonParser p) throws IOException
    {
        ...
        case ID_START_OBJECT:
            writeStartObject();
            while (p.nextToken() != com.townmc.utils.jackson.core.JsonToken.END_OBJECT) {

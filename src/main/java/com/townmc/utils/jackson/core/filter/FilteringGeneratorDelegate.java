...
import com.townmc.utils.jackson.core.util.JsonGeneratorDelegate;
...
public class FilteringGeneratorDelegate extends JsonGeneratorDelegate
{
     ...
     * actually outputs.
     */
    protected com.townmc.utils.jackson.core.filter.TokenFilterContext _filterContext;
    ...
    public FilteringGeneratorDelegate(JsonGenerator d, com.townmc.utils.jackson.core.filter.TokenFilter f,
    ...
    public void writeStartArray() throws IOException
    {
        ...
        if (_itemFilter == com.townmc.utils.jackson.core.filter.TokenFilter.INCLUDE_ALL) { // include the whole sub-tree?
        ...
        if (_itemFilter != com.townmc.utils.jackson.core.filter.TokenFilter.INCLUDE_ALL) {
    ...
    public void writeStartObject() throws IOException
    {
        ...
        com.townmc.utils.jackson.core.filter.TokenFilter f = _filterContext.checkValue(_itemFilter);
        if (f == null) {
            return;
        }
    ...
    {
        com.townmc.utils.jackson.core.filter.TokenFilter state = _filterContext.setFieldName(name);
        if (state == null) {
            _itemFilter = null;
            return;
        }
        if (state == com.townmc.utils.jackson.core.filter.TokenFilter.INCLUDE_ALL) {
            _itemFilter = state;
    ...
    {
        com.townmc.utils.jackson.core.filter.TokenFilter state = _filterContext.setFieldName(name.getValue());
        if (state == null) {
            _itemFilter = null;
            return;
        }
    ...
    public void writeString(String value) throws IOException
    {
        ...
        if (_itemFilter != com.townmc.utils.jackson.core.filter.TokenFilter.INCLUDE_ALL) {
            com.townmc.utils.jackson.core.filter.TokenFilter state = _filterContext.checkValue(_itemFilter);
            if (state == null) {
                return;
            }
            if (state != com.townmc.utils.jackson.core.filter.TokenFilter.INCLUDE_ALL) {

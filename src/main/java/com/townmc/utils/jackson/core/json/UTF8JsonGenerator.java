...
import com.townmc.utils.jackson.core.io.CharTypes;
import com.townmc.utils.jackson.core.io.CharacterEscapes;
import com.townmc.utils.jackson.core.io.IOContext;
import com.townmc.utils.jackson.core.io.NumberOutput;
import com.townmc.utils.jackson.core.json.JsonGeneratorImpl;
import com.townmc.utils.jackson.core.json.JsonWriteContext;
    ...
    extends JsonGeneratorImpl
{
    ...
    public void writeFieldName(String name)  throws IOException
    {
        ...
        if (status == com.townmc.utils.jackson.core.json.JsonWriteContext.STATUS_EXPECT_VALUE) {
            _reportError("Can not write a field name, expecting a value");
        }
        if (status == com.townmc.utils.jackson.core.json.JsonWriteContext.STATUS_OK_AFTER_COMMA) { // need comma
    ...
    public void writeFieldName(SerializableString name) throws IOException
    {
        ...
        if (status == com.townmc.utils.jackson.core.json.JsonWriteContext.STATUS_OK_AFTER_COMMA) {
            if (_outputTail >= _outputEnd) {
                _flushBuffer();
            }
            _outputBuffer[_outputTail++] = BYTE_COMMA;
    ...
    {
        _verifyValueWrite("start an object");
        com.townmc.utils.jackson.core.json.JsonWriteContext ctxt = _writeContext.createChildObjectContext();
        _writeContext = ctxt;
        if (forValue != null) {
    ...
    protected final void _verifyValueWrite(String typeMsg) throws IOException
    {
        ...
        byte b;
        switch (status) {
        case com.townmc.utils.jackson.core.json.JsonWriteContext.STATUS_OK_AS_IS:
        default:
            return;
        case com.townmc.utils.jackson.core.json.JsonWriteContext.STATUS_OK_AFTER_COMMA:
            b = BYTE_COMMA;
            break;
        case com.townmc.utils.jackson.core.json.JsonWriteContext.STATUS_OK_AFTER_COLON:
            b = BYTE_COLON;
            break;
        case com.townmc.utils.jackson.core.json.JsonWriteContext.STATUS_OK_AFTER_SPACE: // root-value separator

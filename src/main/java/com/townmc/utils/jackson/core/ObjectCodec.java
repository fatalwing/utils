...
import com.townmc.utils.jackson.core.TreeCodec;
...
/**
 * Abstract class that defines the interface that {@link com.townmc.utils.jackson.core.JsonParser} and
 ...
 * <code>com.townmc.utils.jackson.databind.ObjectMapper</code>,
    ...
    implements Versioned // since 2.3
{
     ...
     */
    public abstract <T> T readValue(com.townmc.utils.jackson.core.JsonParser p, Class<T> valueType)
        throws IOException;
     ...
     */
    public abstract <T> T readValue(com.townmc.utils.jackson.core.JsonParser p, TypeReference<?> valueTypeRef)
        throws IOException;
     ...
     * {@link java.util.Map}).
     */
    public abstract <T> T readValue(com.townmc.utils.jackson.core.JsonParser p, ResolvedType valueType)
        throws IOException;
     ...
     */
    public abstract <T> Iterator<T> readValues(com.townmc.utils.jackson.core.JsonParser p, Class<T> valueType)
        throws IOException;
     ...
     * all with same specified value type.
     */
    public abstract <T> Iterator<T> readValues(com.townmc.utils.jackson.core.JsonParser p, TypeReference<?> valueTypeRef)
        throws IOException;
     ...
     * all with same specified value type.
     */
    public abstract <T> Iterator<T> readValues(com.townmc.utils.jackson.core.JsonParser p, ResolvedType valueType)
        throws IOException;
     ...
     * using set of {@link com.townmc.utils.jackson.core.TreeNode} instances. Returns
     ...
     */
    @Override
    public abstract <T extends com.townmc.utils.jackson.core.TreeNode> T readTree(com.townmc.utils.jackson.core.JsonParser p) throws IOException;
    
    @Override
    public abstract void writeTree(JsonGenerator gen, com.townmc.utils.jackson.core.TreeNode tree) throws IOException;
    ...
    /**
     * Method for constructing a {@link com.townmc.utils.jackson.core.JsonParser} for reading
     * contents of a JSON tree, as if it was external serialized
     * JSON content.
     */
    @Override
    public abstract com.townmc.utils.jackson.core.JsonParser treeAsTokens(com.townmc.utils.jackson.core.TreeNode n);
     ...
     */
    @Deprecated
    public com.townmc.utils.jackson.core.JsonFactory getJsonFactory() { return getFactory(); }

    /**
     * Accessor for finding underlying data format factory
     * ({@link com.townmc.utils.jackson.core.JsonFactory}) codec will use for data binding.
     * 
     * @since 2.1
     */

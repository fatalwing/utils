...
import com.townmc.utils.jackson.core.json.DupDetector;
...
public final class JsonReadContext extends JsonStreamContext
{
    ...
    protected com.townmc.utils.jackson.core.json.DupDetector _dups;
    ...
    public JsonReadContext(JsonReadContext parent, com.townmc.utils.jackson.core.json.DupDetector dups, int type, int lineNr, int colNr) {
        super();
        _parent = parent;
        _dups = dups;
        _type = type;
    ...
    */
    ...
    public JsonReadContext withDupDetector(com.townmc.utils.jackson.core.json.DupDetector dups) {
        _dups = dups;
        return this;
    }
    ...
    public static JsonReadContext createRootContext(int lineNr, int colNr, com.townmc.utils.jackson.core.json.DupDetector dups) {
        return new JsonReadContext(null, dups, TYPE_ROOT, lineNr, colNr);
    }

    public static JsonReadContext createRootContext(com.townmc.utils.jackson.core.json.DupDetector dups) {
    ...
    public com.townmc.utils.jackson.core.json.DupDetector getDupDetector() {
        return _dups;
    }
